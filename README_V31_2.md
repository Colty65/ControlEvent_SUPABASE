...
- La ficha **Donado producto** ahora usa el mismo conjunto de datos que la cabecera inferior de productos donados.
- La zona inferior **PRODUCTOS DONADOS PARA LOS RESPONSABLES SELECCIONADOS** lista todos los productos con donación del filtro actual, no solo los que no tienen compra planificada.
...
- Cache nuevo: `controlevent-shell-v31-2`.
