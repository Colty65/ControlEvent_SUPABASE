# Zuzu Router SOMBRA · v3_0_exp

La fase SOMBRA ya ha cumplido su función de validación. **La producción v3_0_exp usa ya la arquitectura nueva Gemini → herramientas ControlEvent → Gemini → presentación canónica.**
