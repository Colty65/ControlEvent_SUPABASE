# ControlEvent v26.8 - Index slim legacy JS
...
- Se actualiza la versión a `ControlEvent v26.8`.
- Se actualiza caché PWA a `controlevent-shell-v26-8`.
- Diagnóstico actualizado con métricas de adelgazamiento de v26.5 y v26.8.
