...
- Mapa de recursos: en la cabecera `MAS PRODUCTO DONADO FUERA DE NECESIDAD DE COMPRA` se elimina el resumen `· X PRODUCTOS · VALOR ESTIMADO ...`.
...
- Versión actualizada a `ControlEvent v50.24` en cabecera, `version.js`, service worker, exportaciones y backup.
- Backup: se conserva la corrección de v40.0 para el alcance TODOS.

## Aplicación del parche

Copiar el contenido de este parche sobre el proyecto actual v40.0, aceptando sustituir archivos.
