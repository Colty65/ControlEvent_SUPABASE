...
(function(){
  ...
  function enrichRowDefaults(row){
    ...
    if(p){
      // v10_5: no sustituye el literal leÃ­do por la IA. Mantiene el texto del ticket
  ...
  function aiPendingScore(pname, a){
    ...
    // Si ambos productos tienen sabor, deben coincidir. Evita Fanta limÃ³n â†” Fanta naranja o tÃ© limÃ³n â†” fanta limÃ³n.
    ...
    // TE al limÃ³n â†” FUZE Tea limÃ³n: TE/TEA es el producto, pero se exige que coincida tambiÃ©n el sabor o precio.
  ...
  console.info('[CE v10_5 Alta IA] producto similar, candidatos Pte.Compra, segmento/destino editables y actualizaciÃ³n PRODUCTOS instalada. Prueba: window.__ceOpenTicketAutoV104()');
})();
