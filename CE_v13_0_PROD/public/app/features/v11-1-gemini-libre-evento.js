/* ControlEvent v13.0_prod - AnalÃ­tica libre de explotaciÃ³n del evento.
...
(function(){
  ...
  function injectButton(){
    ...
    var btn=document.createElement('button'); btn.type='button'; btn.id='ceGeminiLibreBtn'; btn.className='ce-ai-free-btn'; btn.title='AnalÃ­tica libre'; btn.setAttribute('aria-label','AnalÃ­tica libre'); btn.textContent='âœ¨ðŸ“Š';
    bindOpenButton(btn);
  ...
  function modalHtml(){
    return '<div class="ce-ai-overlay" id="ceGeminiLibreOverlay" role="dialog" aria-modal="true">'+
      '<div class="ce-ai-modal">'+
        '<div class="ce-ai-head"><h2>âœ¨ AnalÃ­tica libre</h2><div id="ceAiEventTitle">'+eventTitleHtml()+'</div><div class="spacer"></div><button type="button" class="ce-ai-close" id="ceAiClose">Cerrar</button></div>'+
