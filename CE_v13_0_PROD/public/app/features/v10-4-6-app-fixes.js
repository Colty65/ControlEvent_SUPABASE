...
(function(){
  ...
  function makeDownloadButton(cls, img, name){
    var btn=document.createElement('button'); btn.type='button'; btn.className='outline small ce-v1046-download '+cls; btn.textContent='â¬‡ï¸'; btn.title='Descargar foto'; btn.setAttribute('aria-label','Descargar foto'); btn.setAttribute('data-ce-download-bound','1');
