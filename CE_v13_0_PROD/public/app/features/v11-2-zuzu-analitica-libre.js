...
(function(){
  ...
  function modalHtml(){
    return '<div class="ce-ai-overlay" id="ceGeminiLibreOverlay" role="dialog" aria-modal="true">'+
      '<div class="ce-ai-modal">'+
        ...
        '</div>'+
        '<div class="ce-ai-result" id="ceAiResult"><div class="ce-ai-card"><h3>Primera versiÃ³n</h3><div class="ce-ai-answer">Soy Zuzu. PregÃºntame sobre ingresos, compras, donaciones, tickets, responsables, tiendas, documentos, productos, valoraciÃ³n o comparativas entre eventos. Si la peticiÃ³n es demasiado amplia, te pedirÃ© que la concretes para no darte una respuesta sesgada.</div></div></div>'+ 
      '</div></div>';
  }
  function openModal(){
    injectStyle();
  ...
  async function runAi(){
    ...
    setStatus('Zuzu estÃ¡ preparando los datosâ€¦', 'ok');
    var resEl=$('ceAiResult');
    resEl.innerHTML='<div class="ce-ai-card ce-ai-loading"><h3>ðŸ§¡ Zuzu estÃ¡ trabajando</h3><div class="ce-ai-answer"><span class="ce-ai-spinner">â³</span> Preparando contexto seguro, extrayendo datos completos y consultando Gemini...</div></div>';
    try{
