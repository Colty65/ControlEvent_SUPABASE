...
(function(){
  ...
  function toast(msg){
    // v9.5.1: sin avisos flotantes negros; solo consola para depuraciÃ³n.
  ...
  console.info(LOG,'activo en HEAD: COMPRAS RPC FIX38 con recarga determinista tras baja y situaciÃ³n por RPC');
})();
