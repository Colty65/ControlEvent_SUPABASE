# ControlEvent v26.5 - reducción inicial de index.html
...
- Se actualiza el Service Worker a `controlevent-shell-v26-5` y se cachean los nuevos assets.
- Se mantiene el orden de los estilos legacy para respetar precedencias.
- Se actualizan cadenas de versión a `ControlEvent v26.5` / `ControlEvent_v26_5`.

## Métrica de index.html

- v26.4: 21,412 líneas; 1,418,313 bytes.
- v26.5: 20,393 líneas; 1,166,152 bytes.
