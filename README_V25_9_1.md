...
- La versión visible pasa a `ControlEvent v25.9.1`.
- El cache PWA pasa a `controlevent-shell-v25-9-1` para forzar actualización.
...
3. Si todo coincide, preparar una v25.9.1 o v26.0 donde las vistas empiecen a usar `app.calculationsV259` en lugar de las funciones legacy.
