...
async function buildBackupWorkbook(fullState, scope){
  ...
  try{
    ...
    console.warn('[ControlEvent v1.0_exp] No se pudieron añadir ACCESOS/META al BACKUP.',globalError?.message||globalError);
  ...
  try{
    ...
    console.warn('[ControlEvent v1.0_exp] No se pudieron añadir HITOS/LG al BACKUP.',operationalError?.message||operationalError);
  ...
  try{
    ...
    console.warn('[ControlEvent v1.0_exp] No se pudo añadir Cuadre Banco al BACKUP de servidor.',bankError?.message||bankError);
