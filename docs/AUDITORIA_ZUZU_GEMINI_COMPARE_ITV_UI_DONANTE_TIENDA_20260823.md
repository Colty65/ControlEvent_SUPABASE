# Auditoría ControlEvent v4_1_exp · Gemini/CE + ITV + COMPRAS/DONACIONES
...
- `v4_1_exp_exp_exp_exp` => `v4_1_exp`
- prefijo => `ControlEvent_v4_1_exp`

Ejemplo esperado:

`ControlEvent_v4_1_exp_ITV_Zuzu_2026-08-23T...-FULL_CERT.json`
