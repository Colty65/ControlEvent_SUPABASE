# Auditoría v3_0_exp · Ledger físico + analítica + COMPRAS/DONACIONES proporcionales

Cambios aplicados sobre `ControlEvent_v3_0_exp_ZUZU_ITV_ORACULO_EJECUCION_CAPABILITIES_COMPRAS_DONACIONES_AUDITED.zip`.
