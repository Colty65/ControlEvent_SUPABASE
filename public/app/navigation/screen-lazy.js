/* ControlEvent v26_prod_1.1 - Carga diferida por pantalla sin tocar operativa estable */
...
async function activateScreen(name, options = {}){
  ...
  try{
    ...
    state.activations.push(item);
    console.warn('[ControlEventScreenLazy/v30.7] No se pudo activar pantalla', name, error);
    return item;
  }
}
...
function print(){
  const report = info();
  console.group('[ControlEventScreenLazy/v30.7] Carga diferida por pantalla');
