/* ControlEvent v29.3 - Carga diferida por pantalla sin tocar operativa estable */
import { VERSION } from '../version.js';

const SCREEN_LAZY_VERSION = 'v29.3';
const state = {
...
async function activateScreen(name, options = {}){
  ...
  try{
    ...
    state.activations.push(item);
    console.warn('[ControlEventScreenLazy/v29.3] No se pudo activar pantalla', name, error);
    return item;
  }
}
...
function print(){
  const report = info();
  console.group('[ControlEventScreenLazy/v29.3] Carga diferida por pantalla');
