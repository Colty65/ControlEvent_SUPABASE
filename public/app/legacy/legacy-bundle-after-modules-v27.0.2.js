...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #62. */
  ...
  function exportSeedSafe(){
    try{
      ...
      if(excel && typeof excel.run === 'function' && !exportSeedSafe.__legacyFallback){
        return excel.run('backup', {source:'legacy-click-v2702', calledAt:new Date().toISOString()});
      }
    }catch(_){ }
...
/* ControlEvent v27.0.2 - JS legacy extraido de public/index.html. Bloque inline #63. */
