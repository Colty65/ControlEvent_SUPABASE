...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #62. */
...
(function(){
  ...
  async function exportExcelV257(){
    ...
    // v27.6: las hojas RESUMEN_MODULAR y GRAFICAS_MODULAR fueron útiles para auditoría,
    ...
    try{
      if(window.ControlEventExcel && typeof window.ControlEventExcel.protectWorkbook === 'function'){
        await window.ControlEventExcel.protectWorkbook(wb, {source:'infoevento-v27.6'});
      }else{
        for(const ws of wb.worksheets){
          try{
            ...
            console.warn('[ControlEvent v27.6] No se pudo proteger hoja INFOEVENTO', ws?.name, protectError);
          }
        }
      }
    }catch(error){
      console.warn('[ControlEvent v27.6] No se pudo aplicar protección final al INFOEVENTO.', error);
    }
...
/* ControlEvent v27.6 - JS legacy extraido de public/index.html. Bloque inline #63. */
