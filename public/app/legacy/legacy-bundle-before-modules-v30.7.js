/* ControlEvent v33.4 - Bundle legacy generado desde scripts legacy-inline extraídos. */
/* Mantiene el orden original de ejecución para compatibilidad. */

;/* ===== BEGIN legacy-inline-01.js ===== */

/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #1. */
...
async function exportSeedWorkbook(){
  ...
  wb.creator = 'ControlEvent v33.4 - ©oltyLAB ’26';
  wb.created = new Date();
  ...
  a.download = 'ControlEvent_v33_4_descarga_datos.xlsx';
  a.click();
...
async function exportExcel(){
  ...
  putText(wsRes,r,1,'Generado por'); putText(wsRes,r++,2,'ControlEvent v33.4 - ©oltyLAB ’26');
  ...
  link.download = `${(ev.titulo || 'evento').replace(/\s+/g,'_')}_ControlEvent_v33_4.xlsx`;
  link.click();
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #2. */
(function(){
  ...
  function excelFileName(ev){
    ...
    return `ControlEvent_v33_4-${cleanFilePart(ev?.titulo || 'evento')}_${dd}${mm}${yyyy}.xlsx`;
  }
  function graphData(){
    const b = budgetSummary();
...
(function(){
  ...
  window.excelFileName = function(ev){
    ...
    const mm = String(d.getMonth()+1).padStart(2,'0');
    const yyyy = String(d.getFullYear());
    return `ControlEvent_v33_4_INFOEVENTO-${title}_${yyyy}${mm}${dd}.xlsx`;
  };
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #3. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #4. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #5. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #6. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #7. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #8. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #9. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #10. */
/* ==== V15.1 AJUSTES ==== */
(function(){
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #11. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #12. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #13. */
/* ==== V16.0 PATCH FINAL ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => (typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? ''));
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #14. */
/* ==== V16.2 REWORK ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? '');
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #15. */
/* ==== V16.2 FIXES ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? '');
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #16. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #17. */
...
(function(){
  ...
  function emittedByTextV171(date=new Date()){
    ...
    return `Emitido por “©oltyLAB ’26_ControlEvent_v33_4_${dd}${mm}${yyyy}_${hh}:${mi}:${ss}”`;
  }
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #18. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #19. */
/* ==== V18.1: tooltips redondeados, backup por evento y Excel INGRESOS ==== */
(function(){
  const VERSION = 'ControlEvent v33.4';
  const VERSION_FILE = 'ControlEvent_v33_4';
  const norm = v => String(v ?? '').trim();
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #20. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #21. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #22. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #23. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #24. */
(function(){
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #25. */
...
(function(){
  ...
  function normalizeDownloadName(name){
    let n = String(name || '');
    n = n.replace(/^ControlEvent_v\d+_\d+(?:_\d+)?/i, VERSION_FILE);
    n = n.replace(/ControlEvent_v33_4/ig, VERSION_FILE);
    return n;
  }
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #26. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #27. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #28. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #29. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #30. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #31. */
/* ==== V21.0: producto duplicado permitido si cambia la tienda + globos estables ==== */
(function(){
  const VERSION='ControlEvent v33.4'; const VERSION_FILE='ControlEvent_v33_4';
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #32. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #33. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #34. */
...
(function(){
  ...
  window.exportExcel=exportExcel=async function(){
    try{
      ...
      console.group('ERROR INFOEVENTO - ControlEvent v33.4');
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #35. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #36. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #37. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #38. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #39. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #40. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #41. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #42. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #43. */
(function(){
  'use strict';
  const VERSION='v22.8';
  const $=id=>document.getElementById(id);
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #44. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #45. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #46. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #47. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #48. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #49. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #50. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #51. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #52. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #53. */
...
/* ControlEvent v33.4 - JS legacy extraido de public/index.html. Bloque inline #54. */
(function(){
  const VERSION = 'ControlEvent v33.4';
  const VERSION_FILE = 'ControlEvent_v33_4';
  const $ = id => document.getElementById(id);
