...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #1. */
...
async function exportSeedWorkbook(){
  ...
  a.download = 'ControlEvent_v13.0_prod_descarga_datos.xlsx';
  a.click();
...
async function exportExcel(){
  ...
  link.download = `${(ev.titulo || 'evento').replace(/\s+/g,'_')}_ControlEvent_v13.0_prod.xlsx`;
  link.click();
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #2. */
(function(){
  ...
  function excelFileName(ev){
    ...
    return `ControlEvent_v13.0_prod-${cleanFilePart(ev?.titulo || 'evento')}_${dd}${mm}${yyyy}.xlsx`;
  }
  function graphData(){
    const b = budgetSummary();
...
(function(){
  ...
  window.excelFileName = function(ev){
    ...
    const mm = String(d.getMonth()+1).padStart(2,'0');
    const yyyy = String(d.getFullYear());
    return `ControlEvent_v13.0_prod_INFOEVENTO-${title}_${yyyy}${mm}${dd}.xlsx`;
  };
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #3. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #4. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #5. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #9. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #10. */
/* ==== V15.1 AJUSTES ==== */
(function(){
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #11. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #12. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #13. */
/* ==== V16.0 PATCH FINAL ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => (typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? ''));
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #14. */
/* ==== V16.2 REWORK ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? '');
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #15. */
/* ==== V16.2 FIXES ==== */
(function(){
  const $ = id => document.getElementById(id);
  const esc = v => typeof escapeHtml === 'function' ? escapeHtml(v) : String(v ?? '');
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #16. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #17. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #19. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #21. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #24. */
(function(){
...
(function(){
  ...
  function normalizeDownloadName(name){
    let n = String(name || '');
    n = n.replace(/^ControlEvent_v\d+_\d+(?:_\d+)?/i, VERSION_FILE);
    n = n.replace(/ControlEvent_v13.0_prod/ig, VERSION_FILE);
    return n;
  }
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #26. */
...
(function(){
  ...
  function normalizeDownloadName(name){
    let n = String(name || '');
    n = n.replace(/^ControlEvent_v\d+_\d+(?:_\d+)?/i, VERSION_FILE);
    n = n.replace(/ControlEvent_v13.0_prod_\d(?:_\d+)?/ig, VERSION_FILE);
    return n;
  }
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #27. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #28. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #29. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #31. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #32. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #34. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #35. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #38. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #43. */
(function(){
  'use strict';
  const VERSION='v22.8';
  const $=id=>document.getElementById(id);
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #44. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #45. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #48. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #49. */
/* ==== v23.6.4 local: no precargar state pesado, no localStorage pesado, fotos como archivos ==== */
(function(){
  'use strict';
  const VERSION='ControlEvent v13.0_prod';
  const SESSION_KEY='ControlEvent_v13.0_prod_session';
  const $=id=>document.getElementById(id);
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #53. */
...
/* ControlEvent v13.0_prod - JS legacy extraido de public/index.html. Bloque inline #54. */
(function(){
  const VERSION = 'ControlEvent v13.0_prod';
  const VERSION_FILE = 'ControlEvent_v13.0_prod';
  const $ = id => document.getElementById(id);
