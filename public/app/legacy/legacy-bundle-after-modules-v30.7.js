...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #62. */
...
(function(){
  ...
  async function addDocumentosInfoEventoV85(wb, x){
    ...
    try{
      ...
      console.warn('[ControlEvent v10_5_prod] No se pudo añadir DOCUMENTOS DEL EVENTO al INFOEVENTO.', error);
    }
  }
      ...
      if(window.ControlEventExcel && typeof window.ControlEventExcel.protectWorkbook === 'function'){
        ...
        for(const ws of wb.worksheets){
          try{
            ...
            console.warn('[ControlEvent v10_5_prod] No se pudo proteger hoja INFOEVENTO', ws?.name, protectError);
          }
        }
      }
    }catch(error){
      console.warn('[ControlEvent v10_5_prod] No se pudo aplicar protección final al INFOEVENTO.', error);
    }
...
/* ControlEvent v10_5_prod - JS legacy extraido de public/index.html. Bloque inline #63. */
