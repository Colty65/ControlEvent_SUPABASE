...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #62. */
      ...
      if(window.ControlEventExcel && typeof window.ControlEventExcel.protectWorkbook === 'function'){
        ...
        for(const ws of wb.worksheets){
          try{
            ...
            console.warn('[ControlEvent v3.6_prod] No se pudo proteger hoja INFOEVENTO', ws?.name, protectError);
          }
        }
      }
    }catch(error){
      console.warn('[ControlEvent v3.6_prod] No se pudo aplicar protección final al INFOEVENTO.', error);
    }
...
/* ControlEvent v3.6_prod - JS legacy extraido de public/index.html. Bloque inline #63. */
