...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #62. */
...
(function(){
  ...
  async function exportExcelV257(){
    ...
    try{
      if(window.ControlEventResumenSheet && typeof window.ControlEventResumenSheet.attachToInfoEventoWorkbook === 'function'){
        window.ControlEventResumenSheet.attachToInfoEventoWorkbook(wb, {sheetName:'RESUMEN_MODULAR', source:'exportExcelV257-v27.4.3'});
      }
    }catch(error){
      console.warn('[ControlEvent v27.4.3] No se pudo adjuntar RESUMEN_MODULAR; se mantiene INFOEVENTO legacy.', error);
    }
    try{
      if(window.ControlEventGraficasSheet && typeof window.ControlEventGraficasSheet.attachToInfoEventoWorkbook === 'function'){
        window.ControlEventGraficasSheet.attachToInfoEventoWorkbook(wb, {sheetName:'GRAFICAS_MODULAR', source:'exportExcelV257-v27.4.3'});
      }
    }catch(error){
      console.warn('[ControlEvent v27.4.3] No se pudo adjuntar GRAFICAS_MODULAR; se mantiene INFOEVENTO legacy.', error);
    }
    try{
      if(window.ControlEventExcel && typeof window.ControlEventExcel.protectWorkbook === 'function'){
        await window.ControlEventExcel.protectWorkbook(wb, {source:'infoevento-v27.4.3'});
      }else{
        for(const ws of wb.worksheets){
          try{
            ...
            console.warn('[ControlEvent v27.4.3] No se pudo proteger hoja INFOEVENTO', ws?.name, protectError);
          }
        }
      }
    }catch(error){
      console.warn('[ControlEvent v27.4.3] No se pudo aplicar protección final al INFOEVENTO.', error);
    }
...
/* ControlEvent v27.4.3 - JS legacy extraido de public/index.html. Bloque inline #63. */
