...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #55. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #56. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #57. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #58. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #59. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #60. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #61. */
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #62. */
  ...
  async function exportExcelV257(){
    ...
    try{
      if(window.ControlEventResumenSheet && typeof window.ControlEventResumenSheet.attachToInfoEventoWorkbook === 'function'){
        window.ControlEventResumenSheet.attachToInfoEventoWorkbook(wb, {sheetName:'RESUMEN_MODULAR', source:'exportExcelV257-v27.4'});
      }
    }catch(error){
      console.warn('[ControlEvent v27.4] No se pudo adjuntar RESUMEN_MODULAR; se mantiene INFOEVENTO legacy.', error);
    }
    try{
      if(window.ControlEventGraficasSheet && typeof window.ControlEventGraficasSheet.attachToInfoEventoWorkbook === 'function'){
        window.ControlEventGraficasSheet.attachToInfoEventoWorkbook(wb, {sheetName:'GRAFICAS_MODULAR', source:'exportExcelV257-v27.4'});
      }
    }catch(error){
      console.warn('[ControlEvent v27.4] No se pudo adjuntar GRAFICAS_MODULAR; se mantiene INFOEVENTO legacy.', error);
    }
...
/* ControlEvent v27.4 - JS legacy extraido de public/index.html. Bloque inline #63. */
