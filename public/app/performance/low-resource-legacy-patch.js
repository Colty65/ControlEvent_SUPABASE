/* ControlEvent v50.10 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.10]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.10] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
