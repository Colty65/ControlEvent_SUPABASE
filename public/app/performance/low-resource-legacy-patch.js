/* ControlEvent v50.15 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.15]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.15] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
