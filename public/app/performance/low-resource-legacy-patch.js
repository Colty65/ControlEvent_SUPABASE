/* ControlEvent v50.11 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.11]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.11] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
