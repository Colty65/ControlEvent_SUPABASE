/* ControlEvent v4.0_prod - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v4.0_prod]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v4.0_prod] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
