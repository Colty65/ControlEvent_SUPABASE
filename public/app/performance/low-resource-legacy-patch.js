/* ControlEvent v23_prod_r2 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v23_prod_r2]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v23_prod_r2] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
