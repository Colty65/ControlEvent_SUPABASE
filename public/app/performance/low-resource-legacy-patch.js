/* ControlEvent v50.8 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.8]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.8] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
