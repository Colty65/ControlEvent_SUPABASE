/* ControlEvent v50.229 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.229]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.229] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
