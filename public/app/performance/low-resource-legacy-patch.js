/* ControlEvent v50.19 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.19]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.19] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
