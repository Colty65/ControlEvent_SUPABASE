/* ControlEvent v30.12 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v30.12]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v30.12] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
