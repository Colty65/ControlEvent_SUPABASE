/* ControlEvent v50.24 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.24]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.24] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
