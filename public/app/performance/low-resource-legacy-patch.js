/* ControlEvent v1.0/pr - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v1.0/pr]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v1.0/pr] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
