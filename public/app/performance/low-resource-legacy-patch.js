/* ControlEvent v27_prod_1.1 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v27_prod_1.1]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v27_prod_1.1] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
