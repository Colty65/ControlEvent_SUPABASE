/* ControlEvent v50.4 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.4]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.4] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
