/* ControlEvent v50.3 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.3]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.3] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
