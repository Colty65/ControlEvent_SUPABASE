/* ControlEvent v50.18 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.18]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.18] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
