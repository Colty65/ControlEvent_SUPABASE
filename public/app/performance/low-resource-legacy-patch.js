/* ControlEvent v31.5 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v31.5]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v31.5] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
