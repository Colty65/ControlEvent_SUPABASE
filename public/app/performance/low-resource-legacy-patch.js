/* ControlEvent v30.13 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v30.13]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v30.13] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
