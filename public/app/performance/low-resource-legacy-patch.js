/* ControlEvent v50.0 - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v50.0]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v50.0] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
