/* ControlEvent v30.8 - LowResourceLegacyPatch
...
(function(){
  ...
  function liteRender(){
    ...
    try{
      ...
      // Punto clave v30.8: primer render autenticado y cambio real de evento no se recortan.
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v30.8]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v30.8] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
