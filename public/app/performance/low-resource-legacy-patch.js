/* ControlEvent v8.2.1_prod - LowResourceLegacyPatch
...
(function(){
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v8.2.1_prod]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v8.2.1_prod] Render legacy recortado + Mapa de recursos activado.'); }catch(_){ }
})();
