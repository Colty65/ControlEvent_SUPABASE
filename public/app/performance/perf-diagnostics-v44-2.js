/* ControlEvent v45.6 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v45.6: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v45.6 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v45.6: limpieza automática desactivada';
  }
...
Optimización v45.6: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  function ensureUi(){
    injectCss();
    // v45.6: no recrear el botón/panel en cada refresco de instalación.
  ...
  // v45.6: PERF solo se ofrece en PC para usuarios GD/RW; sin UI ni instrumentación activa en móvil/tablet/RO.
  setInterval(() => {
    install();
