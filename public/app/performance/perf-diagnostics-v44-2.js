/* ControlEvent v44.7.1 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v44.7.1: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v44.7.1 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v44.7.1: limpieza automática desactivada';
  }
  ...
  function updatePanel(){
    ...
    panel.innerHTML = `
      <h3>Diagnóstico rendimiento · v44.7.1</h3>
      <div class="grid">
...
Optimización v44.7.1: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  // v44.7.1: refresco ligero del panel PERF mientras está abierto, sin podas automáticas.
  setInterval(() => {
    installWrappers();
    installRenderOptimizer();
