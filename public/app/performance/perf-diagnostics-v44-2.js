/* ControlEvent v45.7 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v45.7: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v45.7 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v45.7: limpieza automática desactivada';
  }
...
Optimización v45.7: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  function ensureUi(){
    injectCss();
    // v45.7: no recrear el botón/panel en cada refresco de instalación.
  ...
  // v45.7: PERF solo se ofrece en PC para usuarios GD/RW; sin UI ni instrumentación activa en móvil/tablet/RO.
  setInterval(() => {
    install();
