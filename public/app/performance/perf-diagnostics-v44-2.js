/* ControlEvent v45.0 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v45.0: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v45.0 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v45.0: limpieza automática desactivada';
  }
  ...
  function updatePanel(){
    ...
    panel.innerHTML = `
      <h3>Diagnóstico rendimiento · v45.0</h3>
      <div class="grid">
...
Optimización v45.0: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  // v45.0: PERF solo se ofrece en PC para usuarios GD/RW; sin UI ni instrumentación activa en móvil/tablet/RO.
  setInterval(() => {
    install();
