/* ControlEvent v44.6 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v44.6: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v44.6 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v44.6: limpieza automática desactivada';
  }
...
Optimización v44.6: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}${loadLine}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  // v44.6: refresco ligero del panel PERF mientras está abierto, sin podas automáticas.
  setInterval(() => {
    installWrappers();
    installRenderOptimizer();
