/* ControlEvent v45.5 - Diagnóstico de rendimiento robusto.
...
(function(){
  ...
  function installRenderOptimizer(){
    // v45.5: el diagnóstico ya NO limpia automáticamente el DOM.
    // La limpieza global de v44.2/v45.5 era útil para medir, pero generaba demasiadas pasadas
    ...
    renderOptimizer.lastReason = 'v45.5: limpieza automática desactivada';
  }
...
Optimización v45.5: limpiezas ${window.__ceV443Stats?.prunes||0}, nodos ${window.__ceV443Stats?.clearedNodes||0}\nActualizado: ${last.updatedAt}\nArranque: ${last.bootMs} ms</pre>
  ...
  function ensureUi(){
    injectCss();
    // v45.5: no recrear el botón/panel en cada refresco de instalación.
  ...
  // v45.5: PERF solo se ofrece en PC para usuarios GD/RW; sin UI ni instrumentación activa en móvil/tablet/RO.
  setInterval(() => {
    install();
