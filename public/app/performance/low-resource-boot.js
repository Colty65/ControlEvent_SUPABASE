/* ControlEvent v30.9.1.1 - LowResourceBoot
...
(function(){
  ...
  function interval(ms){
    ...
    // En v30.9.1 los intervalos legacy repetitivos pasan a modo "vigilancia", no a modo "repintado".
  ...
  function panelHtml(){
    ...
    return `
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;font-size:13px">
        ...
        <div><b>Legacy Turbo v30.9.1</b><br>${legacy?.installed ? 'ACTIVO' : 'no instalado'}<br><small>render ligero: ${esc(legacy?.liteRenderCalls || 0)}</small></div>
