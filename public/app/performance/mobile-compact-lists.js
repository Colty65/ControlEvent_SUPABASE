/* ControlEvent v27_prod_1.0 - Modo móvil compacto para listas pesadas.
...
(function(){
  ...
  const api = {
    ...
    print(){ const r = api.inspect(); console.group('[ControlEventMobileCompactLists/ControlEvent v27_prod_1.0] Listas compactas móviles'); console.log('Estado', r); console.groupEnd(); return r; }
  };
