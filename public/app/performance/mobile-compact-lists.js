/* ControlEvent v28.3_prod - Modo móvil compacto para listas pesadas.
...
(function(){
  ...
  const api = {
    ...
    print(){ const r = api.inspect(); console.group('[ControlEventMobileCompactLists/ControlEvent v28.3_prod] Listas compactas móviles'); console.log('Estado', r); console.groupEnd(); return r; }
  };
