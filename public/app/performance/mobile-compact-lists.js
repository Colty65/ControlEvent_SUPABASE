/* ControlEvent v26_prod_1.2 - Modo móvil compacto para listas pesadas.
...
(function(){
  ...
  const api = {
    ...
    print(){ const r = api.inspect(); console.group('[ControlEventMobileCompactLists/ControlEvent v26_prod_1.2] Listas compactas móviles'); console.log('Estado', r); console.groupEnd(); return r; }
  };
