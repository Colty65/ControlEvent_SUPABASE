/* ControlEvent v26_prod_1.1 - Modo móvil compacto para listas pesadas.
...
(function(){
  ...
  const api = {
    ...
    print(){ const r = api.inspect(); console.group('[ControlEventMobileCompactLists/ControlEvent v26_prod_1.1] Listas compactas móviles'); console.log('Estado', r); console.groupEnd(); return r; }
  };
