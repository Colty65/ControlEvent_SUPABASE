/* ControlEvent v15_prod - Zuzu / Analítica libre de explotación del evento.
...
(function(){
  ...
  async function runAi(){
    ...
    resEl.innerHTML='<div class="ce-ai-card ce-ai-loading"><h3>🧡 Zuzu está pensando...</h3><div class="ce-ai-thinking"><div class="ce-ai-thinking-orb" aria-hidden="true"></div><div class="ce-ai-thinking-lines">Estoy leyendo el evento y preparando la respuesta.<small>Analizando ingresos, compras, donaciones, productos y contexto seleccionado...</small></div></div></div>';
    try{
