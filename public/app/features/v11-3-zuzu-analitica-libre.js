/* ControlEvent v1.0_exp - Zuzu / Analítica libre de explotación del evento.
...
(function(){
  ...
  function ensureZuzuUserPreface(value){
    ...
    // v1.0_exp: la respuesta empieza directamente. Eliminamos también el saludo
  ...
  function responsePdfTitle(data, prompt){
    ...
    return 'ControlEvent_v1.0_exp-responde_Zuzu_a_'+subject+'-'+stamp+'.pdf';
  }
  ...
  function injectStyle(){
    ...
    css.textContent='\n'+
      ...
      '#ceGeminiLibreOverlay .ce-ai-loading,#ceGeminiLibreOverlay .ce-ai-thinking,#ceGeminiLibreOverlay .ce-ai-progress,#ceGeminiLibreOverlay .ce-ai-wait-signal,#ceGeminiLibreOverlay .ce-ai-wait-copy{display:none!important}#ceGeminiLibreOverlay .ce-ai-conversation-rail-head{display:flex;align-items:center;gap:8px}#ceGeminiLibreOverlay .ce-ai-conversation-rail-head>span:first-child{white-space:nowrap}#ceGeminiLibreOverlay .ce-ai-conversation-rail-count{margin-left:auto}#ceGeminiLibreOverlay .ce-ai-rail-typing{display:none;align-items:center;gap:2px;height:31px;margin-left:9px;line-height:1;transform:translateY(1px)}#ceGeminiLibreOverlay .ce-ai-rail-typing.is-on{display:inline-flex}#ceGeminiLibreOverlay .ce-ai-rail-typing i{display:inline-flex;width:15px;height:15px;flex:0 0 15px;align-items:center;justify-content:center;border-radius:999px;background:#7c2d12;color:#fff;border:1px solid rgba(255,255,255,.24);box-shadow:0 2px 5px rgba(124,45,18,.18);font-style:normal;font-size:7px;font-weight:950;letter-spacing:0;text-align:center;opacity:.72;transform-origin:center;will-change:transform,opacity;animation:none}#ceGeminiLibreOverlay .ce-ai-rail-typing.is-on i{animation:ceZuzuRailDot .98s cubic-bezier(.45,.05,.55,.95) infinite}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(1){animation-delay:-.80s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(2){animation-delay:-.72s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(3){animation-delay:-.64s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(4){animation-delay:-.56s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(5){animation-delay:-.48s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(6){animation-delay:-.40s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(7){animation-delay:-.32s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(8){animation-delay:-.24s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(9){animation-delay:-.16s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(10){animation-delay:-.08s}#ceGeminiLibreOverlay .ce-ai-rail-typing i:nth-child(11){animation-delay:0s}@keyframes ceZuzuRailDot{0%,100%{opacity:.62;transform:translate3d(0,8px,0) scale(.92)}25%{opacity:1;transform:translate3d(0,-10px,0) scale(1.12)}50%{opacity:.80;transform:translate3d(0,0,0) scale(1)}75%{opacity:.94;transform:translate3d(0,7px,0) scale(1.06)}}@media(max-width:760px){#ceGeminiLibreOverlay .ce-ai-rail-typing{gap:1px;margin-left:5px}#ceGeminiLibreOverlay .ce-ai-rail-typing i{width:13px;height:13px;flex-basis:13px;font-size:6.5px}}#ceAiPdfPicker{position:fixed;inset:0;z-index:100060;background:rgba(15,23,42,.58);display:flex;align-items:center;justify-content:center;padding:18px}#ceAiPdfPicker .ce-ai-pdf-picker-card{width:min(920px,96vw);max-height:88vh;background:#fff;border:2px solid #f59e0b;border-radius:20px;box-shadow:0 24px 70px rgba(15,23,42,.38);display:flex;flex-direction:column;overflow:hidden}#ceAiPdfPicker .ce-ai-pdf-picker-head{padding:15px 18px;background:linear-gradient(90deg,#fff7ed,#fff);border-bottom:1px solid #fed7aa}#ceAiPdfPicker .ce-ai-pdf-picker-head h3{margin:0 0 5px;color:#7c2d12;font-size:20px}#ceAiPdfPicker .ce-ai-pdf-picker-tools{display:flex;align-items:center;gap:9px;flex-wrap:wrap;padding:10px 16px;border-bottom:1px solid #e2e8f0;background:#f8fafc}#ceAiPdfPicker .ce-ai-pdf-picker-list{overflow:auto;padding:10px 14px;display:grid;gap:8px}#ceAiPdfPicker .ce-ai-pdf-turn{display:grid;grid-template-columns:auto 1fr;gap:10px;border:1px solid #dbeafe;border-radius:12px;padding:9px 10px;background:#fff}#ceAiPdfPicker .ce-ai-pdf-turn input{width:18px;height:18px;margin-top:2px;accent-color:#f97316}#ceAiPdfPicker .ce-ai-pdf-turn-title{font-weight:950;color:#075985;margin-bottom:3px}#ceAiPdfPicker .ce-ai-pdf-turn-line{font-size:12px;color:#334155;line-height:1.3;margin-top:2px}#ceAiPdfPicker .ce-ai-pdf-turn-badges{display:flex;gap:6px;flex-wrap:wrap;margin-top:5px}#ceAiPdfPicker .ce-ai-pdf-badge{font-size:10px;font-weight:850;border-radius:999px;background:#eff6ff;color:#075985;padding:2px 7px}#ceAiPdfPicker .ce-ai-pdf-picker-foot{display:flex;align-items:center;justify-content:flex-end;gap:8px;padding:11px 16px;border-top:1px solid #e2e8f0;background:#fff}#ceAiPdfPicker button{border:1px solid #cbd5e1;background:#fff;color:#0f172a;border-radius:10px;padding:8px 11px;font-weight:900;cursor:pointer}#ceAiPdfPicker .ce-ai-pdf-primary{background:#f97316;color:#fff;border-color:#f97316}#ceAiPdfPicker .ce-ai-pdf-trace-label{display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:850;color:#334155}#ceAiPdfPicker .ce-ai-pdf-trace-label input{width:16px;height:16px;accent-color:#f97316}@media(pointer:coarse){#ceGeminiLibreOverlay .ce-ai-rail-typing i{animation-duration:.98s!important}}\n';
  ...
  function modalHtml(){
    return '<div class="ce-ai-overlay" id="ceGeminiLibreOverlay" role="dialog" aria-modal="true">'+
      '<div class="ce-ai-modal">'+
        '<div class="ce-ai-head"><h2>✨ Soy Zuzu, pregúntame lo que quieras...</h2><span class="ce-ai-version-badge">v1.0_exp</span><div id="ceAiEventTitle">'+eventTitleHtml()+'</div><div class="spacer"></div><button type="button" class="ce-ai-close" id="ceAiClose">Cerrar</button></div>'+
        ...
        '<div class="ce-ai-prompt">'+
          '<div class="ce-ai-prompt-grid">'+
            ...
            '<aside class="ce-ai-conversation-rail" aria-label="Rastro de la conversación">'+
              '<div class="ce-ai-conversation-rail-head"><span>💬 Rastro de conversación</span><span class="ce-ai-rail-typing" id="ceAiRailTyping" aria-label="Pensando..." aria-hidden="true"><i aria-hidden="true">P</i><i aria-hidden="true">e</i><i aria-hidden="true">n</i><i aria-hidden="true">s</i><i aria-hidden="true">a</i><i aria-hidden="true">n</i><i aria-hidden="true">d</i><i aria-hidden="true">o</i><i aria-hidden="true">.</i><i aria-hidden="true">.</i><i aria-hidden="true">.</i></span><span class="ce-ai-conversation-rail-count" id="ceAiConversationRailCount">0</span></div>'+
  ...
  function printSelectedZuzuTurns(selectedIndexes,includeTrace){
    ...
    var title=selected.length===1?responsePdfTitle({__prompt:selected[0].turn.user},selected[0].turn.user):('ControlEvent_v1.0_exp-conversacion_Zuzu-'+dateStamp(now)+'.pdf');
  ...
  function setZuzuRailTyping(on){ var el=$('ceAiRailTyping'); if(!el)return; var active=!!on; el.classList.toggle('is-on',active); el.setAttribute('aria-hidden',active?'false':'true'); }
  function startZuzuThinking(){ clearZuzuThinkingTimer(); setZuzuRailTyping(true); }
  function finishZuzuThinkingFast(){ setZuzuRailTyping(false); return Promise.resolve(); }
  function stopZuzuThinking(){ clearZuzuThinkingTimer(); setZuzuRailTyping(false); window.__ceZuzuThinkingState=null; }
  function zuzuStoragePrefix(){ var v=String(window.__ceVersionLabel||'v1.0_exp').trim(); return 'ControlEvent_'+v+'_zuzu_'; }
  ...
  async function runAi(){
    ...
    // v1.0_exp: la conversación nativa de Gemini es el hilo principal. El evento de pantalla
  ...
  function detailedLineChartHtml(ch, labels, values){
    ...
    // v1.0_exp: globos completos y legibles. Se reparte la serie solo cuando hace falta,
