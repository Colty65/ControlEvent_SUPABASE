...
(function(){
  ...
  function renderZuzuVNextMode(){ var b=$('ceAiVNextMode'); if(!b)return; var on=isZuzuVNextMode(); b.classList.toggle('is-active',on); b.setAttribute('aria-pressed',on?'true':'false'); b.textContent=on?'🧪 VNext ACTIVO':'🧪 VNext'; var strip=$('ceAiConversationMode'); if(strip&&on){strip.className='ce-ai-mode-strip is-conversation';strip.innerHTML='<span class="ce-ai-mode-pill">🧪 VNext P1.6</span><span class="ce-ai-mode-help">Open-world + contratos tipados. Continuidad de filtros, Plan B con gráficas, cuatro niveles de confianza y borrador protegido/recuperable sin perder el fast path. Modo experimental A/B.</span>';}}
  ...
  var ZUZU_RUNTIME_BUILD='20260830-VNEXT-P16-CONTINUITY-DRAFT-SAFE';
