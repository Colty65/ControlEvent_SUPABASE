...
(function(){
  ...
  function renderZuzuVNextMode(){ var b=$('ceAiVNextMode'); if(!b)return; var on=isZuzuVNextMode(); b.classList.toggle('is-active',on); b.setAttribute('aria-pressed',on?'true':'false'); b.textContent=on?'🧪 VNext ACTIVO':'🧪 VNext'; var strip=$('ceAiConversationMode'); if(strip&&on){strip.className='ce-ai-mode-strip is-conversation';strip.innerHTML='<span class="ce-ai-mode-pill">🧪 VNext P1.5</span><span class="ce-ai-mode-help">Open-world + contratos tipados. Cuatro registros: factual, conversación normal, amigo cercano y colegueo; broma anclada, filtros de compras y escenarios Plan B sin perder el fast path. Modo experimental A/B.</span>';}}
