/* ControlEvent v23_prod FIX13 - guardia de escritura ce_ticket_images.
  ...
  if(typeof window.fetch === 'function' && !window.fetch.__ceV85TicketImagesWriteGuardFix13){
    ...
    const wrapped = function(input, init){
      ...
      if(isTicketImagesWrite(url, method)){
        ...
        if(check.block){
          try{ console.warn('[ControlEvent v23_prod] Escritura /api/ticket-images bloqueada:', method, check); }catch(_){ }
