/* ControlEvent v26_prod FIX13 - guardia de escritura ce_ticket_images.
...
(function(){
  ...
  if(typeof window.fetch === 'function' && !window.fetch.__ceV85TicketImagesWriteGuardFix13){
    ...
    const wrapped = function(input, init){
      ...
      if(isTicketImagesWrite(url, method)){
        ...
        if(check.block){
          try{ console.warn('[ControlEvent v26_prod] Escritura /api/ticket-images bloqueada:', method, check); }catch(_){ }
  ...
  window.ControlEventV85TicketImagesWriteGuard = {version:'v26_prod ticket-images write guard', authenticated, liveEventIds, selectedEventId};
})();
