/* ControlEvent v10.4.4_prod - Entrada asistida de COMPRAS mediante foto de ticket e IA.
...
(function(){
  ...
  function openPanel(){
    ...
    // Reentrada limpia: si quedó un panel anterior a medias por una recarga dura, lo retiramos y lo reconstruimos.
  ...
  console.info('[CE v10.4.2 Alta IA] producto similar, candidatos Pte.Compra, segmento/destino editables y actualización PRODUCTOS instalada. Prueba: window.__ceOpenTicketAutoV104()');
})();
