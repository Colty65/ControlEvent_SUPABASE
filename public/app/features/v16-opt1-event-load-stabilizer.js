/* ControlEvent v26_prod_1.1 OPT1 - estabilizador de carga/cambio de evento.
...
(function(){
  ...
  const VERSION = 'v26_prod_1.1_opt_1';
  const SELECT_KEYS = [
  ...
  function notice(msg, ms){
    // v26_prod_1.1_opt_2D: sin avisos negros de carga. El cambio de evento debe ser silencioso.
  ...
  async function doSelectEvent(id, options){
    ...
    try{
      ...
      console.warn('[v26_prod_1.1_opt_1] cambio de evento', err);
    }finally{
      if(my === token){
