/* ControlEvent v28.3_prod OPT1 - estabilizador de carga/cambio de evento.
...
(function(){
  ...
  const VERSION = 'v28.3_prod_opt_1';
  const SELECT_KEYS = [
  ...
  function notice(msg, ms){
    // v28.3_prod_opt_2D: sin avisos negros de carga. El cambio de evento debe ser silencioso.
  ...
  async function doSelectEvent(id, options){
    ...
    try{
      ...
      console.warn('[v28.3_prod_opt_1] cambio de evento', err);
    }finally{
      if(my === token){
