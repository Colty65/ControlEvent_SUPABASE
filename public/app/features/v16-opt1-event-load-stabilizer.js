/* ControlEvent v27_prod_1.0 OPT1 - estabilizador de carga/cambio de evento.
...
(function(){
  ...
  const VERSION = 'v27_prod_1.0_opt_1';
  const SELECT_KEYS = [
  ...
  function notice(msg, ms){
    // v27_prod_1.0_opt_2D: sin avisos negros de carga. El cambio de evento debe ser silencioso.
  ...
  async function doSelectEvent(id, options){
    ...
    try{
      ...
      console.warn('[v27_prod_1.0_opt_1] cambio de evento', err);
    }finally{
      if(my === token){
