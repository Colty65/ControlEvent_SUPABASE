/* ControlEvent v11.0_prod - Gemini libre de explotación del evento.
...
(function(){
  ...
  function injectStyle(){
    ...
    css.textContent='\n'+
      ...
      '.ce-ai-overlay{position:fixed;inset:0;z-index:99995;background:rgba(15,23,42,.50);display:flex;align-items:center;justify-content:center;padding:16px}\n'+
      '.ce-ai-modal{width:min(1180px,96vw);height:min(860px,94vh);background:#fff;border:2px solid #f59e0b;border-radius:22px;box-shadow:0 24px 70px rgba(15,23,42,.34);display:flex;flex-direction:column;overflow:hidden}\n'+
      '.ce-ai-head{display:flex;align-items:center;gap:12px;padding:14px 18px;border-bottom:1px solid #fed7aa;background:linear-gradient(90deg,#fff7ed,#fff)}\n'+
      '.ce-ai-head h2{margin:0;color:#7c2d12;font-size:24px}.ce-ai-head .spacer{flex:1}.ce-ai-close{border-radius:14px!important;background:#fff!important;color:#0f172a!important;border:1px solid #cbd5e1!important;padding:10px 18px!important;font-weight:900!important}\n'+
      '.ce-ai-event-open{color:#15803d;font-weight:900}.ce-ai-event-final{color:#dc2626;font-weight:900}.ce-ai-event-warn{color:#b45309;font-weight:900}.ce-ai-event-state{font-size:13px;color:#475569;font-weight:800}\n'+
      '.ce-ai-prompt{padding:14px 18px;border-bottom:1px solid #e5e7eb;background:#fff}.ce-ai-prompt textarea{width:100%;min-height:112px;resize:vertical;border:1px solid #fb923c;border-radius:14px;padding:12px;font-size:16px;box-sizing:border-box}.ce-ai-toolbar{display:flex;align-items:center;gap:10px;margin-top:10px;flex-wrap:wrap}.ce-ai-run{background:#f97316!important;color:#fff!important;border:0!important;border-radius:14px!important;padding:12px 18px!important;font-weight:900!important}.ce-ai-secondary{background:#fff!important;color:#0f172a!important;border:1px solid #cbd5e1!important;border-radius:14px!important;padding:10px 14px!important;font-weight:900!important}.ce-ai-status{font-weight:900;margin-left:auto}.ce-ai-status.ok{color:#15803d}.ce-ai-status.err{color:#b91c1c}\n'+
      '.ce-ai-result{flex:1;overflow:auto;background:#f8fafc;padding:16px 18px}.ce-ai-card{background:#fff;border:1px solid #dbeafe;border-radius:16px;padding:14px;margin:0 0 14px 0;box-shadow:0 2px 10px rgba(15,23,42,.06)}.ce-ai-card h3{margin:0 0 10px;color:#075985}.ce-ai-answer{white-space:pre-wrap;line-height:1.45;font-weight:650;color:#0f172a}.ce-ai-warning{background:#fff7ed;border-color:#fed7aa;color:#9a3412}.ce-ai-rejected{background:#fef2f2;border-color:#fecaca;color:#991b1b}\n'+
      '.ce-ai-table-wrap{overflow:auto}.ce-ai-table{border-collapse:collapse;width:100%;font-size:14px}.ce-ai-table th,.ce-ai-table td{border:1px solid #dbeafe;padding:7px 8px;text-align:left}.ce-ai-table th{background:#eff6ff;color:#075985}.ce-ai-bars{display:grid;gap:8px}.ce-ai-bar-row{display:grid;grid-template-columns:minmax(120px,260px) 1fr auto;align-items:center;gap:10px}.ce-ai-bar-label{font-weight:800;color:#0f172a;overflow:hidden;text-overflow:ellipsis}.ce-ai-bar-track{height:22px;background:#e2e8f0;border-radius:999px;overflow:hidden}.ce-ai-bar-fill{height:100%;background:#38bdf8;border-radius:999px}.ce-ai-bar-value{font-weight:900;color:#075985;min-width:78px;text-align:right}.ce-ai-files{display:flex;gap:8px;flex-wrap:wrap}.ce-ai-file-btn{background:#e0f2fe!important;color:#075985!important;border:1px solid #7dd3fc!important;border-radius:12px!important;padding:8px 12px!important;font-weight:900!important}.ce-ai-preview{margin-top:10px;background:#0f172a;color:#e2e8f0;border-radius:14px;padding:12px;max-height:240px;overflow:auto;white-space:pre-wrap}\n'+
      '@media(max-width:760px){.ce-ai-modal{width:98vw;height:96vh}.ce-ai-head h2{font-size:18px}.ce-ai-free-btn{height:42px;min-width:46px;font-size:21px}.ce-ai-prompt textarea{min-height:96px}.ce-ai-bar-row{grid-template-columns:1fr}.ce-ai-bar-value{text-align:left}}\n';
