/* ControlEvent v4_1_exp FIX23 - rendimiento real:
...
(function(){
  ...
  window.ControlEventFix23Performance = {version:'v4_1_exp_fix23_performance_dom_event_scope', run, renderCompras:()=>renderCompraKind('compra'), renderDonaciones:()=>renderCompraKind('donacion')};
})();
