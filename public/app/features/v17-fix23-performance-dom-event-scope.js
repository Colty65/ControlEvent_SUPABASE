/* ControlEvent v28.3_prod FIX23 - rendimiento real:
...
(function(){
  ...
  window.ControlEventFix23Performance = {version:'v28.3_prod_fix23_performance_dom_event_scope', run, renderCompras:()=>renderCompraKind('compra'), renderDonaciones:()=>renderCompraKind('donacion')};
})();
