/* ControlEvent v50.17 - entrada limpia tras login y proteccion de globos.
...
(function(){
  ...
  function mustForcePicker(){
    ...
    // v50.17: si el usuario ya ha elegido un evento valido, no seguir forzando selectedEventId=''
