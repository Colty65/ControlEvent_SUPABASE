/* ControlEvent v28.5_prod - entrada limpia tras login y proteccion de globos.
...
(function(){
  ...
  function patchSelectedEventChange(){
    ...
    document.addEventListener('change', ev => {
      ...
      if(id){
        clearForcePicker();
        try{ sessionStorage.setItem('controlevent_v44_event_chosen_after_login','1'); sessionStorage.setItem('ControlEvent_v3_0_prod_event_chosen','1'); sessionStorage.setItem('ce_v250_event_chosen','1'); }catch(_){ }
