/* ControlEvent v50.18 - entrada limpia tras login y proteccion de globos.
...
(function(){
  ...
  function mustForcePicker(){
    ...
    // v50.18: si el usuario ya ha elegido un evento valido, no seguir forzando selectedEventId=''
