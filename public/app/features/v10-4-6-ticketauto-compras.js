...
(function(){
  ...
  function aiPendingSimilar(pname, a){
    ...
    // Té al limón: exige TE/TEA y otro rasgo común; así FANTA LIMON no se empareja con TE AL LIMON.
    ...
    // La similitud difusa solo se permite si además hay una palabra real común, no solo precio o letras internas.
  ...
  console.info('[CE v10.4.6 Alta IA] producto similar, candidatos Pte.Compra, segmento/destino editables y actualización PRODUCTOS instalada. Prueba: window.__ceOpenTicketAutoV104()');
})();
