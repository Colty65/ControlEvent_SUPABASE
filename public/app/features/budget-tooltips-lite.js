/* ControlEvent v3_0_exp - Globos ligeros para RESUMEN PRESUPUESTARIO.
...
(function(){
  ...
  // v3_0_exp 2026-08-13: apertura directa de justificantes de INGRESOS desde el globo de RESUMEN.
  ...
  function openBudgetIncomeReceipt(event){
    ...
    if(id && api && typeof api.showReceiptModal === 'function'){
      try{ api.showReceiptModal(id, event); return true; }catch(error){ console.warn('[v3_0_exp] visor justificante Resumen', error); }
    }
    return true;
  }
