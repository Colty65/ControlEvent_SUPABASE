/* ControlEvent v4_1_exp - Globos ligeros para RESUMEN PRESUPUESTARIO.
...
(function(){
  ...
  // v4_1_exp 2026-08-13: apertura directa de justificantes de INGRESOS desde el globo de RESUMEN.
  ...
  function openBudgetIncomeReceipt(event){
    ...
    if(id && api && typeof api.showReceiptModal === 'function'){
      try{ api.showReceiptModal(id, event); return true; }catch(error){ console.warn('[v4_1_exp] visor justificante Resumen', error); }
    }
    return true;
  }
