/* ControlEvent v28.5_prod - Vista aerea desde Mapa de recursos.
   FIX9:
...
(function(){
  ...
  function safeOpen(ev){
    ...
    try{ openModal(); }catch(err){
      try{ console.error('[ControlEvent v28.5_prod] Error abriendo vista aérea', err); }catch(_){ }
  ...
  function injectStyle(){
    ...
    style.textContent = `
      ...
      .ce-v19-metrics{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:10px;margin-bottom:12px;}.ce-v19-metric{border-radius:18px;border:1px solid rgba(255,255,255,.42);padding:13px;box-shadow:0 4px 14px rgba(15,23,42,.035);position:relative;overflow:hidden;backdrop-filter:blur(4px);}.ce-v19-metric::after{content:"";position:absolute;inset:0;background:linear-gradient(135deg,rgba(255,255,255,.46),rgba(255,255,255,.07));pointer-events:none}.ce-v19-metric span{display:block;font-size:11px;font-weight:1000;color:#475569!important;letter-spacing:.05em;text-shadow:none!important;position:relative;z-index:1;}.ce-v19-metric strong{display:block;margin-top:5px;font-size:24px;font-weight:1000;color:var(--ce-v19-metric-color,#0f172a)!important;text-shadow:none!important;position:relative;z-index:1;}
