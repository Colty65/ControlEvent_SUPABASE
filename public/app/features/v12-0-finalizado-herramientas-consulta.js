/* ControlEvent v21_prod - desbloqueo real de herramientas de consulta con evento Finalizado.
...
(function(){
  ...
  function downloadBlob(blob, filename){
    ...
    const a = document.createElement('a'); a.href = url; a.download = filename || ('ControlEvent_v21_prod_BACKUP_' + Date.now() + '.xlsx');
  ...
  async function runBackupDownload(scope){
    ...
    downloadBlob(blob, fileNameFromDisposition(res.headers.get('content-disposition')) || 'ControlEvent_v21_prod_BACKUP.xlsx');
  }
