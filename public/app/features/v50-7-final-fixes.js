/* ControlEvent v50.7 - recuperacion estable sobre v50.4.
...
(function(){
  ...
  const VERSION = 'ControlEvent v50.7';
  const VERSION_FILE = 'ControlEvent_v50_7';
  const INSTALLED = '__ceV507FinalFixes';
  if(window[INSTALLED]) return;
  window[INSTALLED] = true;

  const SESSION_KEY = 'ControlEvent_v26_9_session';
  const LOGOUT_KEY = 'ControlEvent_v50_7_logout_at';
