/* ControlEvent v27_prod_1.1 - logon limpio y globos rehidratados sin bucles pesados.
...
(function(){
  ...
  const CHOSEN_KEYS = [
    ...
    'ControlEvent_v27_prod_1.1_event_chosen',
    'ControlEvent_v27_prod_1.1_event_chosen',
    'ControlEvent_v27_prod_1.1_event_chosen',
  ...
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_v27_prod_1.1_selected_event','ControlEvent_v27_prod_1.1_selected_event','ControlEvent_v27_prod_1.1_selected_event'];
  const SESSION_KEYS = ['ControlEvent_v27_prod_1.1_session','ControlEvent_v27_prod_1.1_session','ControlEvent_v27_prod_1.1_session'];
