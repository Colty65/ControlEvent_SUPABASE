/* ControlEvent v10_5_prod - logon limpio y globos rehidratados sin bucles pesados.
...
(function(){
  ...
  const CHOSEN_KEYS = [
    ...
    'ControlEvent_v10_5_prod_event_chosen',
    'ControlEvent_v10_5_prod_event_chosen',
    'ControlEvent_v10_5_prod_event_chosen',
  ...
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_v10_5_prod_selected_event','ControlEvent_v10_5_prod_selected_event','ControlEvent_v10_5_prod_selected_event'];
  const SESSION_KEYS = ['ControlEvent_v10_5_prod_session','ControlEvent_v10_5_prod_session','ControlEvent_v10_5_prod_session'];
