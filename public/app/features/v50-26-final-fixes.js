/* ControlEvent v4_0_exp - logon limpio y globos rehidratados sin bucles pesados.
...
(function(){
  ...
  const CHOSEN_KEYS = [
    ...
    'ControlEvent_v4_0_exp_event_chosen',
  ...
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_' + 'v30' + '_prod_selected_event','ControlEvent_v4_0_exp_selected_event','ControlEvent_v29_prod_selected_event'];
  const SESSION_KEYS = ['ControlEvent_' + 'v30' + '_prod_session','ControlEvent_v4_0_exp_session','ControlEvent_v29_prod_session'];
