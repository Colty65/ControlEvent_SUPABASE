/* ControlEvent v50.26 - logon limpio y globos rehidratados sin bucles pesados.
...
(function(){
  ...
  const CHOSEN_KEYS = [
    ...
    'ControlEvent_v50_26_event_chosen',
    'ControlEvent_v50_25_event_chosen',
  ...
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_v50_26_selected_event','ControlEvent_v50_25_selected_event','ControlEvent_v50_24_selected_event'];
  const SESSION_KEYS = ['ControlEvent_v50_26_session','ControlEvent_v50_25_session','ControlEvent_v50_24_session'];
  ...
  function hydrateTooltips(reason){
    ...
    setChosen();
    hideWelcome();
    try{ window.ControlEventBudgetLiteTips?.rehydrate?.(reason || 'v50.26'); }catch(_){ }
