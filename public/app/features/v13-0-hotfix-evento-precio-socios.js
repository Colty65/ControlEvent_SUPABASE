/* ControlEvent v1.0_exp hotfix - mantenimiento EVENTOS robusto y planificación socios obligatorios.
...
(function(){
  'use strict';
  const VERSION = 'v1.0_exp_hotfix_evento_precio_socios_robusto';
