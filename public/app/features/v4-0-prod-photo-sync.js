/* ControlEvent v10.4.2_prod - sincronizacion y visor de fotos de INGRESOS/TICKETS.
...
(function(){
  ...
  async function hydrateImages(force){
    ...
    }catch(error){ console.warn('[ControlEvent v10.4.2_prod] No se pudieron hidratar fotos.', error); }
