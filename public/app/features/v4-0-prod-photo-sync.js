/* ControlEvent v27_prod_1.0 - sincronizacion y visor de fotos de INGRESOS/TICKETS.
...
(function(){
  ...
  async function hydrateImages(force){
    ...
    }catch(error){ console.warn('[ControlEvent v27_prod_1.0] No se pudieron hidratar fotos.', error); }
