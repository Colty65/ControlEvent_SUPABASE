/* ControlEvent v3_0_exp OPT2G - GRAFICAS: solo renderer V46 estricto.
...
(function(){
  ...
  function runFinal(reason){
    ...
    metrics.finalRuns++;
    runningFinal = true;
    try{ fn.call(window.ControlEventV462 || window.ControlEventV461 || window.ControlEventV460 || window, {force:true, reason:'v3_0_exp_opt_2g_' + (reason || 'final')}); }
    catch(err){ console.warn('[v3_0_exp_opt_2g] render final gráficas', err); }
