/* ControlEvent v30_prod OPT2G - GRAFICAS: solo renderer V46 estricto.
...
(function(){
  ...
  function runFinal(reason){
    ...
    metrics.finalRuns++;
    runningFinal = true;
    try{ fn.call(window.ControlEventV462 || window.ControlEventV461 || window.ControlEventV460 || window, {force:true, reason:'v30_prod_opt_2g_' + (reason || 'final')}); }
    catch(err){ console.warn('[v30_prod_opt_2g] render final gráficas', err); }
