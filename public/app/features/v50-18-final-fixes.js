/* ControlEvent v50.18 - estabilización final de login, selección de evento y globos.
...
(function(){
  ...
  function renderActiveTab(tab){
    ...
    try{ window.ControlEventV447?.renderActive?.(active); }
      ...
      else if(active === 'graficas') call('renderGraficas', [{force:true, reason:'v50.18'}]);
  ...
  async function refreshHere(ev){
    ...
    }catch(error){ console.warn('[v50.18] Refres falló', error); }
