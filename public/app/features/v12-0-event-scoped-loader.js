/* ControlEvent v26_prod_1.0 - carga fiable por evento sin refrescos en bucle.
...
(function(){
  ...
  async function load(id, reason){
    ...
    try{
      ...
      console.warn('[ControlEvent v26_prod_1.0] Carga por evento fallida:', err && err.message || err);
    }finally{
