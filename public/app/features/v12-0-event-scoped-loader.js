/* ControlEvent v24_prod-02 - carga fiable por evento sin refrescos en bucle.
...
(function(){
  ...
  async function load(id, reason){
    ...
    try{
      ...
      console.warn('[ControlEvent v24_prod-02] Carga por evento fallida:', err && err.message || err);
    }finally{
