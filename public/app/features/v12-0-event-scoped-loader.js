/* ControlEvent v28.5.2_prod - carga fiable por evento sin refrescos en bucle.
...
(function(){
  ...
  async function load(id, reason){
    ...
    try{
      ...
      console.warn('[ControlEvent v28.5.2_prod] Carga por evento fallida:', err && err.message || err);
    }finally{
