/* ControlEvent v10.4.6_prod - BACKUP con EVENTO_ID real, sin EVxxx para eventos.
...
(function(){
  'use strict';
  const VERSION = 'ControlEvent v10.4.6_prod';
  const VERSION_FILE = 'ControlEvent_v10_4_6_prod';
