/* ControlEvent v26_prod_1.0 - parche mínimo sobre v50.24.
   - Cambio de usuario tras Salir: al elegir evento se fuerza estado de evento listo y globos rehidratados.
   - Versión única visible y en descargas: ControlEvent v26_prod_1.0.
...
(function(){
  ...
  const SESSION_KEYS_TO_CLEAR_ON_LOGOUT = ['ControlEvent_v26_prod_1.0_session','ControlEvent_v3_0_prod_session'];
