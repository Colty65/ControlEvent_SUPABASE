/* ControlEvent v28.5_prod - correccion puntual sobre la version anterior.
   ...
   - Version: ControlEvent v28.5_prod.
*/
(function(){
  'use strict';
  ...
  function forceEventChoice(reason){
    ...
    try{ window.ControlEventV447?.render?.({force:true, delay:0, reason:reason || 'v50.19-login-event-choice'}); }catch(_){ }
  }
