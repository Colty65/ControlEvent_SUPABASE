/* ControlEvent v23_prod_r1 - HOTFIX47: avance en logo, carga scoped estable, documentos/mantenimiento. */
(function(){
  'use strict';
  ...
  async function loadScopedEventForSwitch(eventId, token){
    ...
    for(let attempt = 1; attempt <= 3; attempt++){
      ...
      try{
        ...
        if(attempt >= 3) console.warn('[ControlEvent v23_prod_r1 HF47] carga scoped de evento fallida:', error?.message || error);
