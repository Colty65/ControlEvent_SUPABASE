/* ControlEvent v30_prod - logo inicial Peña El Arrastre fijo por CSS, sin ficha/texto ni cambios de tamaño. */
(function(){
  'use strict';
  ...
  function injectStyle(){
    ...
    st.textContent=`
      ...
      #noEventMessage::before{content:""!important;display:block!important;width:clamp(210px,38vw,340px)!important;height:clamp(160px,29vw,258px)!important;max-width:76vw!important;max-height:42vh!important;background:url('./assets/icons/penya-el-arrastre-welcome-v30.jpg') center/contain no-repeat!important;border-radius:0!important;filter:none!important;transform:none!important;transition:none!important;animation:none!important;}
    `;
  ...
  window.ControlEventV17LogoFijo={install,hideLogo,showLogoIfNoEvent,version:'v30_prod_logo_el_arrastre_una_vez'};
})();
