...
(function(){
  ...
  function bind(){
    $('ztClose').onclick=close;$('ztAntonioLab').disabled=false;$('ztAntonioLab').removeAttribute('disabled');$('ztAntonioLab').onclick=()=>{window.location.assign('/antonio-lab.html');};$('ztInterpreter').onclick=()=>window.ceOpenZuzuInterpreterLab?.();$('ztExecution').onclick=()=>window.ceOpenZuzuExecutionLab?.();$('ceZuzuTestOverlay').addEventListener('click',e=>{if(e.target.id==='ceZuzuTestOverlay')close();});
