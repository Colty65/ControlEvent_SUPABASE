...
(function(){
  ...
  const ITV_LANGUAGE_BUILD='20260901-P121-DERIVE-LABEL-LIMIT-DOCS-FIELDS-RETRY-GOLDEN110-NHC';
  ...
  function modal(){return `<div id="ceZuzuTestOverlay" role="dialog" aria-modal="true" aria-label="ITV de Zuzu"><div class="zt-modal">
    ...
    <div class="zt-top">
      ...
      </div><div class="zt-controls zt-run-controls"><label>Máx. coste<br><input id="ztMaxCost" type="number" min="0.02" max="5" step="0.05" value="0.25"> €</label><label title="Máximo de preguntas de IA que se ejecutarán en AI-SMOKE o FULL-CERT. No crea casos nuevos; si pones más que los disponibles, se ejecutan todos.">Máx. casos IA<br><input id="ztMaxCases" type="number" min="1" max="200" step="1" value="100"></label><button class="primary" id="ztStart">▶ INICIAR</button><button class="danger" id="ztStop">■ DETENER</button><button id="ztRetry" style="display:none!important">↻ REPETIR INCIDENCIAS</button><button class="next" id="ztNext">SIGUIENTE →</button></div></div>
    </div>
