...
(function(){
  ...
  function style(){
    ...
    const s=document.createElement('style');s.id='ceZuzuTestConsoleStyle';s.textContent=`
      ...
      @media(max-width:1180px){#ceZuzuTestOverlay{padding:6px!important}#ceZuzuTestOverlay .zt-modal{width:calc(100vw - 12px);height:calc(100vh - 12px)}.zt-top{grid-template-columns:1fr;max-height:46vh;overflow:auto!important}.zt-data{grid-template-columns:repeat(5,minmax(0,1fr))}.zt-history-grid{grid-template-columns:minmax(0,1fr) auto auto}.zt-run-controls{grid-template-columns:repeat(3,minmax(0,1fr))}.zt-row{grid-template-columns:55px 90px 1fr}.zt-row .zt-expected,.zt-row .zt-actual{grid-column:3}.zt-ms{grid-column:1}.zt-modes{grid-template-columns:1fr}.zt-head .zt-sub{display:none}}
