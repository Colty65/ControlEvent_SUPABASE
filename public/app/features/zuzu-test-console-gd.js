...
(function(){
  ...
  function style(){
    ...
    const s=document.createElement('style');s.id='ceZuzuTestConsoleStyle';s.textContent=`
      ...
      .zt-head{display:flex;align-items:center;gap:9px;padding:7px 12px;background:linear-gradient(90deg,#eff6ff,#fff);border-bottom:1px solid #bae6fd;min-height:48px;flex:0 0 auto}
      ...
      .zt-top{display:grid;grid-template-columns:minmax(520px,.96fr) minmax(650px,1.44fr);gap:7px;padding:6px 9px;border-bottom:1px solid #e2e8f0;background:#f8fafc;flex:0 0 auto}
      .zt-panel{background:#fff;border:1px solid #dbeafe;border-radius:12px;padding:7px 8px;min-width:0}.zt-panel h3{margin:0;color:#075985;font-size:12px}.zt-panel-head{display:flex;align-items:center;gap:7px;margin-bottom:5px}.zt-panel-head .zt-history-note{margin-left:auto;max-width:55%;text-align:right}.zt-mini-primary{margin-left:auto!important;background:#eff6ff!important;border-color:#7dd3fc!important;color:#075985!important;-webkit-text-fill-color:#075985!important;padding:5px 8px!important;font-size:10px!important}
      .zt-data{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:3px}.zt-pill{border-radius:7px;background:#f8fafc;border:1px solid #dbe4ee;padding:3px 5px;font-size:9px;font-weight:800;color:#475569;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.zt-pill strong{color:#0f172a;font-size:10px}.zt-seed-strip{margin-top:4px!important;padding:4px 6px;border-radius:7px;background:#f8fafc;border:1px solid #e2e8f0;min-height:0!important;font-size:9px!important;line-height:1.15}
      .zt-modes{display:grid;grid-template-columns:repeat(3,1fr);gap:5px}.zt-mode{position:relative;border:1px solid #cbd5e1!important;border-top:3px solid #cbd5e1!important;background:#fff!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;border-radius:10px!important;padding:6px 8px!important;cursor:pointer!important;text-align:left!important;min-height:52px}.zt-mode.active{border-color:#0ea5e9!important;border-top-color:#0284c7!important;background:#eff6ff!important;box-shadow:0 0 0 1px rgba(14,165,233,.10)}.zt-mode b{display:block;font-size:11px}.zt-mode small{display:block;color:#64748b;-webkit-text-fill-color:#64748b!important;margin-top:2px;line-height:1.1;font-size:9px}.zt-mode .free{color:#15803d!important;-webkit-text-fill-color:#15803d!important}.zt-mode .paid{color:#b45309!important;-webkit-text-fill-color:#b45309!important}.zt-mode-status{position:absolute;right:7px;top:6px;font-style:normal;font-size:9px;font-weight:950;padding:2px 5px;border-radius:999px;background:#e2e8f0;color:#475569}.zt-mode-status.good{background:#dcfce7;color:#166534}.zt-mode-status.warn{background:#fef3c7;color:#92400e}.zt-mode-status.bad{background:#fee2e2;color:#991b1b}
      .zt-controls{display:flex;align-items:center;gap:5px;flex-wrap:wrap;margin-top:5px}.zt-run-controls{display:grid;grid-template-columns:auto auto auto auto minmax(145px,1fr) auto;align-items:end;gap:5px;margin-top:6px;padding-top:5px;border-top:1px solid #e2e8f0}.zt-controls button{border:1px solid #94a3b8!important;background:#fff!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;border-radius:8px!important;padding:6px 8px!important;font-weight:950!important;cursor:pointer!important;white-space:nowrap!important;font-size:10px!important}.zt-controls .primary{background:#0284c7!important;color:#fff!important;-webkit-text-fill-color:#fff!important;border-color:#0284c7!important}.zt-controls .danger{background:#fff7f7!important;color:#b91c1c!important;-webkit-text-fill-color:#b91c1c!important;border-color:#fca5a5!important}.zt-controls .danger.running{background:#dc2626!important;color:#fff!important;-webkit-text-fill-color:#fff!important;border-color:#dc2626!important;box-shadow:0 0 0 2px rgba(220,38,38,.12)!important}.zt-controls .next{background:#eef2ff!important;color:#3730a3!important;-webkit-text-fill-color:#3730a3!important;border-color:#a5b4fc!important}.zt-controls label{font-size:11px;font-weight:850;color:#475569}.zt-controls input,.zt-controls select{border:1px solid #cbd5e1;border-radius:8px;padding:6px;font-weight:850;background:#fff;color:#0f172a}.zt-controls input{width:78px}.zt-controls .grow{margin-left:auto}
      .zt-progress-area{padding:5px 9px;border-bottom:1px solid #e2e8f0;background:#fff;flex:0 0 auto}.zt-progress-head{display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center}.zt-progress{height:8px;background:#e2e8f0;border-radius:999px;overflow:hidden}.zt-progress>div{height:100%;width:0;background:linear-gradient(90deg,#0284c7,#22c55e);transition:width .15s}.zt-phase{font-size:10px;font-weight:900;color:#334155;min-height:14px}.zt-live{font-size:9px;color:#64748b;font-weight:850;margin-top:2px;min-height:11px}.zt-stats{display:grid;grid-template-columns:repeat(7,minmax(72px,1fr));gap:4px;margin-top:4px}.zt-stat{min-width:0;border:1px solid #e2e8f0;border-radius:8px;padding:3px 6px;background:#f8fafc;display:flex;align-items:baseline;gap:5px}.zt-stat b{display:block;font-size:13px}.zt-stat span{font-size:8px;color:#64748b;font-weight:850;white-space:nowrap}.zt-stat.ok b{color:#15803d}.zt-stat.ko b{color:#b91c1c}.zt-stat.warn b{color:#c2410c}.zt-stat.cost b{color:#7c3aed}
      .zt-filters{display:flex;gap:4px;flex-wrap:wrap;padding:4px 9px;background:#f8fafc;border-bottom:1px solid #e2e8f0}.zt-filter{border:1px solid #cbd5e1!important;background:#fff!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important;border-radius:999px!important;padding:3px 7px!important;font-size:9px!important;font-weight:900!important;cursor:pointer!important}.zt-filter.active{background:#0f172a!important;color:#fff!important;-webkit-text-fill-color:#fff!important;border-color:#0f172a!important}
      .zt-results{flex:1;min-height:320px;overflow:auto;padding:6px 9px;background:#f8fafc}.zt-row{display:grid;grid-template-columns:58px 116px minmax(220px,1.05fr) minmax(220px,.95fr) minmax(280px,1.45fr) 78px;gap:7px;align-items:start;border:1px solid #e2e8f0;border-left:5px solid #94a3b8;border-radius:10px;background:#fff;padding:7px 8px;margin-bottom:6px;font-size:11px}.zt-row.OK{border-left-color:#22c55e}.zt-row.KO{border-left-color:#ef4444;background:#fff7f7}.zt-row.WARN{border-left-color:#f59e0b;background:#fffaf0}.zt-status{font-weight:950}.zt-row.OK .zt-status{color:#15803d}.zt-row.KO .zt-status{color:#b91c1c}.zt-row.WARN .zt-status{color:#b45309}.zt-cell b{display:block;margin-bottom:2px}.zt-cell span{color:#475569;white-space:pre-wrap;overflow-wrap:anywhere}.zt-ms{text-align:right;color:#64748b;font-weight:800;white-space:pre-line}.zt-empty{padding:34px;text-align:center;color:#64748b;font-weight:850}
      .zt-foot{display:flex;align-items:center;gap:8px;padding:5px 9px;border-top:1px solid #e2e8f0;background:#fff}.zt-cert{font-weight:950}.zt-cert.good{color:#15803d}.zt-cert.warn{color:#b45309}.zt-cert.bad{color:#b91c1c}.zt-history{margin-left:auto;font-size:10px;color:#64748b;font-weight:800}.zt-history-box{margin-top:5px;padding-top:5px;border-top:1px dashed #cbd5e1}.zt-history-grid{display:grid;grid-template-columns:minmax(230px,1fr) auto auto minmax(155px,.55fr) auto;gap:4px;align-items:center}.zt-history-row{display:flex;gap:5px;align-items:center;flex-wrap:wrap}.zt-history-row select,.zt-history-grid select{min-width:0;max-width:none;width:100%}.zt-seed-label{display:flex;align-items:center;gap:4px;font-size:9px;font-weight:900;color:#475569;white-space:nowrap}.zt-seed-label input{width:105px!important;border:1px solid #cbd5e1;border-radius:7px;padding:5px!important;font-weight:850;font-size:10px}.zt-history-row button{background:#fff!important;border:1px solid #94a3b8!important;color:#334155!important;-webkit-text-fill-color:#334155!important;border-radius:9px!important;padding:5px 7px!important;min-height:30px!important;font-size:9px!important;font-weight:900!important;line-height:1.15!important;white-space:nowrap!important}.zt-history-note{font-size:8.5px;color:#64748b;font-weight:750;margin-top:0;line-height:1.1}
      @media(max-width:1180px){.zt-top{grid-template-columns:1fr;overflow:auto;max-height:44vh}.zt-data{grid-template-columns:repeat(5,minmax(0,1fr))}.zt-history-grid{grid-template-columns:1fr auto auto}.zt-seed-label{grid-column:1/2}.zt-run-controls{grid-template-columns:repeat(3,1fr)}.zt-row{grid-template-columns:55px 90px 1fr}.zt-row .zt-expected,.zt-row .zt-actual{grid-column:3}.zt-ms{grid-column:1}.zt-modes{grid-template-columns:1fr}.zt-head .zt-sub{display:none}}
  ...
  function modal(){return `<div id="ceZuzuTestOverlay" role="dialog" aria-modal="true" aria-label="ITV de Zuzu"><div class="zt-modal">
    ...
    <div class="zt-top">
      <div class="zt-panel"><div class="zt-panel-head"><h3>Datos reales · batería</h3><button id="ztGenerate" class="zt-mini-primary">↻ NUEVA BATERÍA</button></div><div id="ztData" class="zt-data"><span class="zt-pill">Cargando datos…</span></div><div id="ztSeedInfo" class="zt-live zt-seed-strip"></div>
        <div class="zt-history-box"><div class="zt-panel-head"><h3>Histórico reproducible</h3><div id="ztHistoryStorage" class="zt-history-note"></div></div><div class="zt-history-grid"><select id="ztHistorySelect"><option value="">Cargando baterías guardadas…</option></select><button id="ztHistoryView">VER</button><button id="ztHistoryReplay">▶ REPETIR</button><label class="zt-seed-label">Semilla <input id="ztSeedReplayInput" inputmode="numeric" placeholder="974813527"></label><button id="ztReplaySeed">↻ REGENERAR</button></div></div>
      </div>
      ...
      </div><div class="zt-controls zt-run-controls"><label>Máx. coste<br><input id="ztMaxCost" type="number" min="0.02" max="5" step="0.05" value="0.25"> €</label><label>Casos IA<br><select id="ztMaxCases"><option>24</option><option selected>36</option><option>48</option></select></label><button class="primary" id="ztStart">▶ INICIAR</button><button class="danger" id="ztStop">■ DETENER</button><button id="ztRetry">↻ REPETIR KO/AVISOS</button><button class="next" id="ztNext">SIGUIENTE →</button></div></div>
    </div>
