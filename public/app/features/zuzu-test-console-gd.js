...
(function(){
  ...
  function bind(){
    $('ztClose').onclick=close;$('ztInterpreter').onclick=()=>window.ceOpenZuzuInterpreterLab?.();$('ceZuzuTestOverlay').addEventListener('click',e=>{if(e.target.id==='ceZuzuTestOverlay')close();});
