...
(function(){
  ...
  function openAntonioLab(){
    const root=$('ceZuzuTestOverlay');if(!root)return;
    closeAntonioLab();
    const ov=document.createElement('div');ov.id='ceAntonioLabOverlay';ov.innerHTML=`<div class="cal-shell"><div class="cal-head"><b>🎙️ ZUZU LAB V3.15</b><span>Oído · VNext/CE · narrador natural · Iapetus voz única</span><span class="cal-spacer"></span><button type="button" class="cal-close" id="calClose">✕ VOLVER A ITV</button></div><iframe id="calFrame" title="ZUZU LAB V3.15" allow="microphone; autoplay" src="/antonio-lab.html?embedded=itv&v=20260905-V315"></iframe></div>`;
