...
(function(){
  ...
  function bind(){
    $('ztClose').onclick=close;$('ztInterpreter').onclick=()=>window.ceOpenZuzuInterpreterLab?.();$('ztExecution').onclick=()=>window.ceOpenZuzuExecutionLab?.();$('ceZuzuTestOverlay').addEventListener('click',e=>{if(e.target.id==='ceZuzuTestOverlay')close();});
