/* ControlEvent v1.0/pr - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v1.0/pr] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
