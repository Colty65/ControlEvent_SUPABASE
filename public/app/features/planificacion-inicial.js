/* ControlEvent v46.5 - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v46.5] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
