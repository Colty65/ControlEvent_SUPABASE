/* ControlEvent v11_3_3_prod - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v11_3_3_prod] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
