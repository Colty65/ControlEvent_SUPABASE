/* ControlEvent v50.229 - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v50.229] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
