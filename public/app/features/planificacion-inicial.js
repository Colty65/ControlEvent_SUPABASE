/* ControlEvent v44.7.1 - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v44.7.1] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
