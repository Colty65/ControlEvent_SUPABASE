/* ControlEvent v45.7 - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v45.7] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
