/* ControlEvent v9.5.1_prod - Planificación inicial por réplica de evento FINALIZADO.
...
(function(){
  ...
  function showPlanificacion(){
    ...
    try{ initForm(); }catch(error){ console.warn('[ControlEvent v9.5.1_prod] No se pudo inicializar el formulario de planificación.', error); }
    unlockPlanControls();
