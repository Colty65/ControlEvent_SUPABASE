/* ControlEvent v27_prod_1.1 · VOZ4 MOVIL ESTABLE
...
(function(){
  ...
  function prepareSpeechText(value){
    ...
    // v27_prod_1.1 · Los marcadores Markdown se conservan en pantalla/PDF, pero no deben pronunciarse.
    s=s.replace(/\*+/g,' ').replace(/(^|\s)#{1,6}(?=\s)/g,'$1').replace(/[`_~]+/g,' ');
    s=s.replace(/\bPte\.?\s*Compra\b/gi,'pendiente de compra');
    // v27_prod_1.1 · Voz: el TTS de algunos navegadores pronuncia mal «línea/líneas».
