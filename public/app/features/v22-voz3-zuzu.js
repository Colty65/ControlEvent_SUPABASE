...
(function(){
  ...
  var BUILD='v2.0_exp-FIX34-VOICE-ROBUST-DIRECT-WAKE-HUMAN-SPOKEN-LABELS';
  ...
  function install(){
    ...
    if(state.ambientEnabled)setTimeout(function(){startCloudRecognition('ambient',false);},350);
