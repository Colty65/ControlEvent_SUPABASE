/* ControlEvent v1.0.1/pr - correccion minima sobre la base estable v50.20.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v50_27_session','ControlEvent_v50_24_session'];
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_v50_27_selected_event','ControlEvent_v50_27_selected_event'];
  const CHOSEN_KEYS = [
    'ce_v250_event_chosen','controlevent_v44_event_chosen_after_login','ControlEvent_v50_27_event_chosen','ControlEvent_v50_25_event_chosen','ControlEvent_v50_24_event_chosen',
