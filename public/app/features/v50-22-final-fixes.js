/* ControlEvent v8.3_prod - correccion minima sobre la base estable v50.20.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v8_3_prod_session','ControlEvent_v8_3_prod_session'];
  const SELECT_KEYS = ['controlevent_v229_selected_event_id','ControlEvent_v8_3_prod_selected_event','ControlEvent_v8_3_prod_selected_event'];
  const CHOSEN_KEYS = [
    'ce_v250_event_chosen','controlevent_v44_event_chosen_after_login','ControlEvent_v8_3_prod_event_chosen','ControlEvent_v8_3_prod_event_chosen','ControlEvent_v8_3_prod_event_chosen',
