/* ControlEvent v28.3_prod - login limpio sin preselección y salida sin recarga pesada.
...
(function(){
  ...
  const LOGOUT_AT_KEY = 'ControlEvent_v28.3_prod_soft_logout_at';
  const CHOSEN_KEYS = [
    ...
    'controlevent_v5022_user_picked_event','ControlEvent_v28.3_prod_event_chosen','ControlEvent_v28.3_prod_selected_event',
    'ControlEvent_v28.3_prod_event_chosen','ControlEvent_v28.3_prod_selected_event','controlevent_v229_selected_event_id'
  ];
