/* ControlEvent v11.1_prod - login limpio sin preselección y salida sin recarga pesada.
...
(function(){
  ...
  const LOGOUT_AT_KEY = 'ControlEvent_v11_1_prod_soft_logout_at';
  const CHOSEN_KEYS = [
    ...
    'controlevent_v5022_user_picked_event','ControlEvent_v11_1_prod_event_chosen','ControlEvent_v11_1_prod_selected_event',
    'ControlEvent_v11_1_prod_event_chosen','ControlEvent_v11_1_prod_selected_event','controlevent_v229_selected_event_id'
  ];
