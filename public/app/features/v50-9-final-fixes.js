/* ControlEvent v8.4.1_prod - correccion puntual sobre v50.19.
...
(function(){
  ...
  const LOGOUT_KEY_508 = 'ControlEvent_v8_4_1_prod_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v8_4_1_prod_logout_at'), null);
