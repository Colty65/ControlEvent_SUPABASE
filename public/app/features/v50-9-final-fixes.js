/* ControlEvent v28.5.2_prod - correccion puntual sobre v50.19.
...
(function(){
  ...
  const SESSION_KEY = 'ControlEvent_v28.5.2_prod_session';
  const LOGOUT_KEY_508 = 'ControlEvent_v28.5.2_prod_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v28.5.2_prod_logout_at'), null);
