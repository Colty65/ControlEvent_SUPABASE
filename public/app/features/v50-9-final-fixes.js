/* ControlEvent v4_0_exp - correccion puntual sobre v50.19.
...
(function(){
  ...
  const SESSION_KEY = 'ControlEvent_v4_0_exp_session';
  const LOGOUT_KEY_508 = 'ControlEvent_v4_0_exp_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v4_0_exp_logout_at'), null);
