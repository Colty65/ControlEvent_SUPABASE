/* ControlEvent v28.0_prod - correccion puntual sobre v50.19.
...
(function(){
  ...
  const LOGOUT_KEY_508 = 'ControlEvent_v28.0_prod_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v28.0_prod_logout_at'), null);
