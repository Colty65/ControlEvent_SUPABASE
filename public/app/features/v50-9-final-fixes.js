/* ControlEvent v30_prod - correccion puntual sobre v50.19.
...
(function(){
  ...
  const SESSION_KEY = 'ControlEvent_v30_prod_session';
  const LOGOUT_KEY_508 = 'ControlEvent_v30_prod_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v30_prod_logout_at'), null);
