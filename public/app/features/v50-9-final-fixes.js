/* ControlEvent v26_prod_1.0 - correccion puntual sobre v50.19.
...
(function(){
  ...
  const LOGOUT_KEY_508 = 'ControlEvent_v26_prod_1.0_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v26_prod_1.0_logout_at'), null);
