/* ControlEvent v7.3.1_prod - correccion puntual sobre v50.19.
...
(function(){
  ...
  const LOGOUT_KEY_508 = 'ControlEvent_v7_3_1_prod_logout_at';
  ...
  async function loginV509(ev){
    ...
    try{
      ...
      safe(() => sessionStorage.removeItem('ControlEvent_v7_3_1_prod_logout_at'), null);
