/* ControlEvent v50.229 - flujo único login/evento y globos estables.
...
(function(){
  ...
  const CHOSEN_KEYS = ['controlevent_v44_event_chosen_after_login','ControlEvent_v25_event_chosen','ce_v5017_event_chosen'];
  const FORCE_KEYS = ['ce_v5015_force_event_picker_after_login','ce_v5013_require_event_choice','ce_v5013_user_picked_event'];
  const STORAGE_SESSION_KEY = 'ControlEvent_v26_9_session';
