/* ControlEvent v28.3_prod · hardlock final de versión visible, descargas e identidad cliente. */
(function(root){
  'use strict';
  const LABEL='v28.3_prod', TEXT='ControlEvent v28.3_prod', FILE='ControlEvent_v28.3_prod', BUILD='20260811-V28-3-PROD', ZIP='ControlEvent_v28.3_prod.zip';
  ...
  function publish(){
    try{root.__ceVersion=TEXT;root.__ceVersionLabel=LABEL;root.__ceBuildId=BUILD;root.VERSION=TEXT;root.VERSION_FILE=FILE;root.ControlEventVersion={label:LABEL,version:TEXT,versionFile:FILE,build:BUILD,zip:ZIP,source:'v28-3-prod-version-hardlock.js'};root.__ceVersionInfo={version:LABEL,label:LABEL,text:TEXT,file:FILE,buildId:BUILD,zipName:ZIP};}catch(_){}
  ...
  function hardlockDownloads(){
    try{
      const proto=HTMLAnchorElement.prototype;if(proto.click.__ceV283VersionHardlock)return;const prev=proto.click;
      ...
      wrapped.__ceV283VersionHardlock=true;proto.click=wrapped;
    }catch(_){}
  }
  ...
  root.ControlEventV283Version={LABEL,TEXT,FILE,BUILD,ZIP,normalizeName,scrubVisible};
})(window);
