/* ControlEvent v3_0_exp FIX24 - modo reposo: reduce ventilador/longtasks en PC y móviles.
...
(function(){
  ...
  function status(){
    ...
    return {
      version:'v3_0_exp_fix24_idle_quiet',
  ...
  window.ControlEventFix24IdleQuiet = {version:'v3_0_exp_fix24_idle_quiet', status, quiet:function(){ clearPerfLiveNoise(); closeStaleTransientUi(); return status(); }};
