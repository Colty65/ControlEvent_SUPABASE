/* ControlEvent v26_prod_1.1 FIX24 - modo reposo: reduce ventilador/longtasks en PC y móviles.
...
(function(){
  ...
  function status(){
    ...
    return {
      version:'v26_prod_1.1_fix24_idle_quiet',
  ...
  window.ControlEventFix24IdleQuiet = {version:'v26_prod_1.1_fix24_idle_quiet', status, quiet:function(){ clearPerfLiveNoise(); closeStaleTransientUi(); return status(); }};
