/* ControlEvent v1.0_exp FIX24 - modo reposo: reduce ventilador/longtasks en PC y móviles.
...
(function(){
  ...
  function status(){
    ...
    return {
      version:'v1.0_exp_fix24_idle_quiet',
  ...
  window.ControlEventFix24IdleQuiet = {version:'v1.0_exp_fix24_idle_quiet', status, quiet:function(){ clearPerfLiveNoise(); closeStaleTransientUi(); return status(); }};
