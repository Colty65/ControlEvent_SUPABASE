/* ControlEvent v8.4_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v8_4_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v8_4_prod_logout_at','ControlEvent_v8_4_prod_logout_at','ControlEvent_v8_4_prod_logout_at'];
