/* ControlEvent v50.26 - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v50_26_session'];
  const LOGOUT_KEYS = ['ControlEvent_v50_26_logout_at','ControlEvent_v50_26_logout_at','ControlEvent_v50_26_logout_at'];
