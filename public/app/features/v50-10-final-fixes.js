/* ControlEvent v9.1_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v9_1_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v9_1_prod_logout_at','ControlEvent_v9_1_prod_logout_at','ControlEvent_v9_1_prod_logout_at'];
