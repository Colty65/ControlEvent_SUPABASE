/* ControlEvent v50.13 - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const LOGOUT_KEYS = ['ControlEvent_v50_13_logout_at','ControlEvent_v50_9_logout_at','ControlEvent_v50_8_logout_at'];
  ...
  // Captura temprana: el listener de v50.13 puede dispararse antes; por eso tambien se ha corregido directamente v50-8-final-fixes.js.
