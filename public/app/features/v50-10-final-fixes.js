...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v13.0_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v13.0_prod_logout_at','ControlEvent_v13.0_prod_logout_at','ControlEvent_v13.0_prod_logout_at'];
