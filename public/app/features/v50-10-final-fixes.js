/* ControlEvent v1.0_exp - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v1.0_exp_session'];
  const LOGOUT_KEYS = ['ControlEvent_v1.0_exp_logout_at','ControlEvent_v1.0_exp_logout_at','ControlEvent_v1.0_exp_logout_at'];
