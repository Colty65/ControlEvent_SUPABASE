/* ControlEvent v9.6_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v9_6_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v9_6_prod_logout_at','ControlEvent_v9_6_prod_logout_at','ControlEvent_v9_6_prod_logout_at'];
