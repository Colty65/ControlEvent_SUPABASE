/* ControlEvent v24_prod-02 - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v24_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v24_prod_logout_at','ControlEvent_v24_prod_logout_at','ControlEvent_v24_prod_logout_at'];
