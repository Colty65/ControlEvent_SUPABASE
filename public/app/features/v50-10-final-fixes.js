/* ControlEvent v3_0_exp - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v3_0_exp_session'];
  const LOGOUT_KEYS = ['ControlEvent_v3_0_exp_logout_at','ControlEvent_v3_0_exp_logout_at','ControlEvent_v3_0_exp_logout_at'];
