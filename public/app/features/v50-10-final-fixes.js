/* ControlEvent v3.5_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v3_5_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v3_5_prod_logout_at','ControlEvent_v3_5_prod_logout_at','ControlEvent_v3_5_prod_logout_at'];
