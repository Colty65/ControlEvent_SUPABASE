/* ControlEvent v28.2_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v28.2_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v28.2_prod_logout_at','ControlEvent_v28.2_prod_logout_at','ControlEvent_v28.2_prod_logout_at'];
