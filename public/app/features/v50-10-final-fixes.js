/* ControlEvent v12.0_prod - ajuste minimo sobre v50.9.
...
(function(){
  ...
  const SESSION_KEYS = ['ControlEvent_v12.0_prod_session'];
  const LOGOUT_KEYS = ['ControlEvent_v12.0_prod_logout_at','ControlEvent_v12.0_prod_logout_at','ControlEvent_v12.0_prod_logout_at'];
