// ControlEvent v26_prod_1.0 · FIX18 mínimo
...
(function(){
  ...
  function injectCss(){
    ...
    const css = `
      /* v26_prod_1.0: recuperar la versión compacta junto al icono CE de la cabecera. */
  ...
  window.ControlEventV19Fix18={version:'v26_prod_1.0_FIX18'};
})();
