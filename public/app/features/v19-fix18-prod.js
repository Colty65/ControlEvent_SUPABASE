// ControlEvent v29_prod · FIX18 mínimo
...
(function(){
  ...
  function injectCss(){
    ...
    const css = `
      /* v29_prod: recuperar la versión compacta junto al icono CE de la cabecera. */
  ...
  window.ControlEventV19Fix18={version:'v29_prod_FIX18'};
})();
