// ControlEvent v26_prod_1.2 · FIX18 mínimo
...
(function(){
  ...
  function injectCss(){
    ...
    const css = `
      /* v26_prod_1.2: recuperar la versión compacta junto al icono CE de la cabecera. */
  ...
  window.ControlEventV19Fix18={version:'v26_prod_1.2_FIX18'};
})();
