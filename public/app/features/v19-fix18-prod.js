// ControlEvent v26_prod_1.1 · FIX18 mínimo
...
(function(){
  ...
  function injectCss(){
    ...
    const css = `
      /* v26_prod_1.1: recuperar la versión compacta junto al icono CE de la cabecera. */
  ...
  window.ControlEventV19Fix18={version:'v26_prod_1.1_FIX18'};
})();
