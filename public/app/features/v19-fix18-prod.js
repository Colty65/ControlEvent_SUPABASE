// ControlEvent v24_prod-02 · FIX18 mínimo
...
(function(){
  ...
  function injectCss(){
    ...
    const css = `
      /* v24_prod-02: recuperar la versión compacta junto al icono CE de la cabecera. */
  ...
  window.ControlEventV19Fix18={version:'v24_prod_FIX18'};
})();
