/* ControlEvent v3.3_prod - Salir duro y logon limpio.
...
(function(){
  ...
  function cleanStorage(){
    ...
    [
      'ControlEvent_v3_3_prod_session','ControlEvent_v3_3_prod_session','ControlEvent_v3_3_prod_session','ControlEvent_v3_3_prod_session','ControlEvent_v26_9_session',
      'ce_v250_event_chosen','ce_event_chosen','controlevent_v44_event_chosen_after_login',
      'controlevent_v229_selected_event_id','ControlEvent_v3_3_prod_selected_event','ControlEvent_v3_3_prod_selected_event','ControlEvent_v3_3_prod_selected_event','ControlEvent_v3_3_prod_selected_event'
  ...
  function hardLogout(event){
    ...
    safe(() => { sessionStorage.setItem('ControlEvent_v3_3_prod_hard_logout_at', String(Date.now())); });
  ...
  function ensureLoginCleanAfterHardLogout(){
    const recent = Number(safe(() => sessionStorage.getItem('ControlEvent_v3_3_prod_hard_logout_at')) || 0);
