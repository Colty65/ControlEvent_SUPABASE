/* ControlEvent v7.2_prod - visor de fotos sin doble apertura; base estable v3.2. */
(function(){
  'use strict';
  ...
  async function hydrateEventImages(force){
    ...
    try{
      ...
      console.warn('[ControlEvent v7.2_prod] No se pudieron hidratar fotos desde BBDD.', error);
    }finally{
      hydrateBusy = false;
    }
    return changed;
