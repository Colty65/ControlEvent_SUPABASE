/* ControlEvent v26_prod_1.1 - visor de fotos sin doble apertura; base estable v3.2. */
(function(){
  'use strict';
  ...
  async function hydrateEventImages(force){
    ...
    try{
      ...
      console.warn('[ControlEvent v26_prod_1.1] No se pudieron hidratar fotos desde BBDD.', error);
    }finally{
      hydrateBusy = false;
    }
    return changed;
