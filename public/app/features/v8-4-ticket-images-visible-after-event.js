/* ControlEvent v11.0_prod - Hidratación puntual de fotos TKxx al volver a un evento.
...
(function(){
  ...
  async function hydrateCurrentEvent(force=false){
    ...
    inflight = (async () => {
      ...
      }catch(err){ console.warn('[ControlEvent v11.0_prod] No se pudieron traer fotos del evento.', err); }
