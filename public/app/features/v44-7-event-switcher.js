/* ControlEvent v3.2_prod - selector de evento unificado y render activo único.
...
(function(){
  ...
  const OLD_CHOSEN_KEY = 'ControlEvent_v3_2_prod_event_chosen';
  const LEGACY_CHOSEN_KEYS = ['ce_v250_event_chosen','ControlEvent_v3_2_prod_event_chosen','ControlEvent_v3_2_prod_event_chosen','controlevent_v5022_user_picked_event'];
  ...
  async function doLoginFast(){
    ...
    try{
      ...
      try{ localStorage.removeItem('ControlEvent_v3_2_prod_session'); }catch(_){ } // v50.27: no persistir sesion ligera
