/* ControlEvent v2.0-pr - selector de evento unificado y render activo único.
...
(function(){
  ...
  const LEGACY_CHOSEN_KEYS = ['ce_v250_event_chosen','ControlEvent_v2_0_pr_event_chosen','ControlEvent_v2_0_pr_event_chosen','controlevent_v5022_user_picked_event'];
  ...
  async function doLoginFast(){
    ...
    try{
      ...
      try{ localStorage.removeItem('ControlEvent_v2_0_pr_session'); }catch(_){ } // v2.0-pr: no persistir sesion ligera
