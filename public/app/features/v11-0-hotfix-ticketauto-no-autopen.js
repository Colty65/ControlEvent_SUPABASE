/* ControlEvent v11.0_prod - HOTFIX mínimo: Ticket Auto no debe abrirse solo.
   Motivo: tras v11.0 algunos arranques dejaban visible Alta asistida de COMPRAS antes de elegir evento.
...
(function(){
  ...
  function closeTicketAutoPanel(reason){
    ...
    if(reason){ try{ console.info('[CE v11.0 hotfix Ticket Auto]', reason); }catch(_){ } }
  }
