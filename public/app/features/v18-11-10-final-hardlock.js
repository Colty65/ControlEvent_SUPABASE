/* ControlEvent v28.5.2_prod - hardlock final de versión, trazabilidad y herramientas laterales. */
(function(){
  'use strict';
  if(window.__ceV181110FinalHardlock) return; window.__ceV181110FinalHardlock=true;
  var VERSION_LABEL='v28.5.2_prod';
  var VERSION_TEXT='ControlEvent v28.5.2_prod';
  var VERSION_FILE='ControlEvent_v28.5.2_prod';
  var BUILD_ID='20260811-V28-5-1-PROD';
  var ZIP_NAME='ControlEvent_v28.5.2_prod.zip';
  ...
  function normalizeVersionValue(value){
    return String(value||'')
      ...
      .replace(/\bv28.5.2_prod\b/ig,VERSION_LABEL);
  }
  ...
  function setGlobals(){
    safe(function(){
      ...
      window.ControlEventVersion={label:VERSION_LABEL,version:VERSION_TEXT,versionFile:VERSION_FILE,build:BUILD_ID,zip:ZIP_NAME,source:'v28.2-prod'};
  ...
  window.ControlEventVersionCheck=function(){
    var front={label:VERSION_LABEL,version:VERSION_TEXT,versionFile:VERSION_FILE,build:BUILD_ID,zip:ZIP_NAME,source:'v28.2-prod'};
