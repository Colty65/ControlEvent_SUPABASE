/* ControlEvent v43.8.6 - Planificación inicial móvil y versión BACKUP.
...
(function(){
  ...
  function safeCall(fn){ try{ return fn && fn(); }catch(err){ console.warn('[ControlEvent v43.8.6]', err); return null; } }
