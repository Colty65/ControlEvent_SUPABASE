/* ControlEvent v28.8 - Diagnóstico de peso legacy y preparación de limpieza.
   Sólo diagnóstico bajo demanda. No modifica la operativa. */
const VERSION = 'v28.8';
const LEGACY_BEFORE = 'legacy-bundle-before-modules-v28.8.js';
const LEGACY_AFTER = 'legacy-bundle-after-modules-v28.8.js';
const LEGACY_PATHS = [
