# ControlEvent v20_prod FIX29 — Planificación Zuzu sin menú fijo
...
- El backend devuelve `version: v20_prod_FIX29_PLANIFICACION_SIN_MENU_FIJO`.
- La ficha ColtyLAB de bienvenida muestra `v20_prod_FIX29_PLANIFICACION_SIN_MENU_FIJO`.
