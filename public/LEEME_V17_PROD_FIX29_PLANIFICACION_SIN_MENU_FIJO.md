# ControlEvent v19_prod FIX29 — Planificación Zuzu sin menú fijo
...
- El backend devuelve `version: v19_prod_FIX29_PLANIFICACION_SIN_MENU_FIJO`.
- La ficha ColtyLAB de bienvenida muestra `v19_prod_FIX29_PLANIFICACION_SIN_MENU_FIJO`.
