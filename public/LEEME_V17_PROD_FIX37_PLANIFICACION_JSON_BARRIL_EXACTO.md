# CE v17_prod FIX37 - Planificación: JSON Gemini y barril exacto
...
2. Backend Planificación/Gemini:
   - El matching de productos también distingue Cerveza AMBAR barril 50l y 30l.
   - La lectura de JSON de Gemini pasa a usar un parser prudente con reparación de comas faltantes entre objetos/arrays y comas colgantes.
   - Si Gemini devuelve JSON roto, la traza conserva rawTextPreview para poder ver la respuesta real.

No se ha tocado gráficas, resumen, globos, fotos ni compras normales.

Versión visible: v17_prod_FIX37_PLANIFICACION_JSON_BARRIL_EXACTO.
