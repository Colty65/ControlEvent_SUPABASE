...
const BACKUP_VERSION = 'ControlEvent v27_prod_1.2';
const BACKUP_VERSION_FILE = 'ControlEvent_v27_prod_1.2';
...
export async function run(options = {}){
  ...
  }catch(bankError){['BANCO_IMPORTACIONES','BANCO_MVTOS','BANCO_TK_LINKS','BANCO_INGRESOS_LINKS','BANCO_PERIODOS','BANCO_ESTADO_MVTO'].forEach(name=>addRows(name,['AVISO'],[[bankError?.message||String(bankError)]]));}
