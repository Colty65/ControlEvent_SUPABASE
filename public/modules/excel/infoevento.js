...
export const meta = {
  ...
  description: 'Controlador modular para INFOEVENTO. Desde v27.6.1 mantiene el libro final limpio: no añade hojas RESUMEN_MODULAR/GRAFICAS_MODULAR por defecto; las herramientas modulares quedan disponibles sólo en standalone.'
};
