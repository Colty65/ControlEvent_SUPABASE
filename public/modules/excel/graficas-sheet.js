...
const GRAFICAS_SHEET_VERSION = 'v27.7.1';
const AUDIT_STORAGE_KEY = 'controlevent:v27.7:graficasModularAudit';
let installed = false;
...
export const meta = {
  ...
  description: 'Módulo real para preparar y escribir una hoja GRAFICAS modular. En v27.7 mantiene el modelo modular para auditoría interna; la descarga standalone queda desactivada porque INFOEVENTO es la fuente fiable.'
};
...
export async function downloadStandaloneGraficas(options = {}){
  const message = 'GRAFICAS standalone desactivado en v27.7: no se genera un Excel independiente porque la fuente fiable es INFOEVENTO. Usa el botón normal de INFOEVENTO para obtener RESUMEN y GRAFICAS correctos.';
