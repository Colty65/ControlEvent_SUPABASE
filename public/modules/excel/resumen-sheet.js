...
const PRODUCT_VERSION = 'v28.5.2_prod';
...
export const meta = {
  ...
  description: 'Módulo real para preparar, validar y escribir una hoja RESUMEN modular. En v28.2 mantiene el modelo modular para auditoría interna; la descarga standalone queda desactivada porque INFOEVENTO es la fuente fiable.'
};
...
export async function downloadStandaloneResumen(options = {}){
  const message = 'RESUMEN standalone desactivado en v28.2: no se genera un Excel independiente porque la fuente fiable es INFOEVENTO. Usa el botón normal de INFOEVENTO para obtener RESUMEN y GRAFICAS correctos.';
