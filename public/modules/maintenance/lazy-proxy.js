/* ControlEvent v30.0 - Proxy ligero para mantenimiento diferido.
...
async function ensure(options = {}){
  ...
  if(!loadingPromise){
    loadingPromise = import('./index.js').then(module => {
      ...
      loadingPromise = null;
      console.warn('[ControlEventMaintenance/v30.0] No se pudo cargar mantenimiento bajo demanda', error);
      throw error;
    });
  }
...
export function installMaintenanceLazyProxy(){
  ...
  const api = {
    ...
    print(){
      ...
      console.group('[ControlEventMaintenance/v30.0] Proxy ligero de mantenimiento');
      console.info(report);
