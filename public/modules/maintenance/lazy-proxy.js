/* ControlEvent v28.4 - Proxy ligero para mantenimiento diferido.
...
async function ensure(options = {}){
  ...
  if(!loadingPromise){
    loadingPromise = import('./index.js').then(module => {
      ...
      loadingPromise = null;
      console.warn('[ControlEventMaintenance/v28.4] No se pudo cargar mantenimiento bajo demanda', error);
      throw error;
    });
  }
...
export function installMaintenanceLazyProxy(){
  ...
  const api = {
    ...
    print(){
      ...
      console.group('[ControlEventMaintenance/v28.4] Proxy ligero de mantenimiento');
      console.info(report);
