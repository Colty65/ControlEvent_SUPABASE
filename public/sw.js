const CACHE_NAME = 'controlevent-shell-v8-3-1-prod';
...
const SHELL_ASSETS = [
  ...
  '/app/features/v8-3-1-ticket-image-scope-backup-fix.js',
  '/app/features/v8-3-1-ticket-images-visible-after-event.js',
