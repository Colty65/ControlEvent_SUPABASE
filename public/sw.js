const CACHE_NAME = 'controlevent-shell-v8-3-2-prod';
...
const SHELL_ASSETS = [
  ...
  '/app/features/v7-3-prod-final-fix.js',
  ...
  '/app/features/v8-3-2-stable-ids.js',
  '/app/features/v8-3-2-ticket-image-scope-backup-fix.js',
  '/app/features/v8-3-2-ticket-images-visible-after-event.js',
