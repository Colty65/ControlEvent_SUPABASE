# ControlEvent v18.9_prod · Zuzu con crónica cronológica de eventos
...
- Se generan dos CSV:
  - `Informe_cronologico_eventos_v18_9_prod.csv`
  - `Informe_cronologico_eventos_detalle_modulos_v18_9_prod.csv`
