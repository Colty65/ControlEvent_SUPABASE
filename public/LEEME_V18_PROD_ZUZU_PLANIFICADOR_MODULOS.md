# ControlEvent v18_prod - Zuzu planificador de módulos

Base: CE_v17_PROD_FIX50_ZUZU_CALIDAD_ANALITICA.

Cambios principales:

- Versión funcional actualizada a `v18_prod` en cabecera, versión visible, service worker, integridad, rutas de servidor, exportaciones, INFOEVENTO y BACKUP.
...
Notas:
- Se mantienen nombres históricos de algunos scripts `v17-fix...` como rutas internas de compatibilidad, pero la versión visible, exportada y declarada es `v18_prod`.
