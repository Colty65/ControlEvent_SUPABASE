# HOTFIX v11.1_prod - Zuzu libre: contexto ampliado de INGRESOS

No cambia la versión visible de la app: sigue siendo v11.1_prod.

Problema detectado:
- Zuzu recibía el total bruto de ingresos (`row.importe`) pero no siempre el cálculo completo de ingresos de socios.
...
- `services/event-ai.service.js`
  ...
  - Refuerza el prompt interno para que Zuzu no use solo el campo bruto `importe` cuando haya socios.
