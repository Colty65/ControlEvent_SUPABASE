...
- Se reduce el límite máximo de contexto enviado a Gemini para evitar peticiones gigantes.
...
## Seguridad
Gemini sigue sin acceder directamente a Supabase, SQL ni BBDD. Solo recibe JSON preparado por ControlEvent, de solo lectura.
