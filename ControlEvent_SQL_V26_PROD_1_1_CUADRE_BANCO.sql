-- ============================================================================
-- ControlEvent v26_prod_1.1 FIX8 · CUADRE BANCO, TRAZABILIDAD DE COMPRAS E INGRESOS
...
-- Actualización segura para instalaciones que ya tenían la versión v26_prod_1.1-02.
...
comment on column public.ce_bank_movements.included is 'Valor inicial heredado. Desde v26_prod_1.1-04 la inclusión efectiva se guarda por evento en ce_bank_event_movement_state.';
