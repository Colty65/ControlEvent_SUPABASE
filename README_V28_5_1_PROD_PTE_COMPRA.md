# ControlEvent v28.5.3_prod · corrección canónica Pte.Compra
...
La identidad activa es `v28.5.3_prod` en aplicación, cliente/servidor, INFOEVENTO y BACKUP interno/externo. `v28.5_prod` se conserva únicamente en la lista de migración de claves antiguas para no perder preferencias/sesión al actualizar.
