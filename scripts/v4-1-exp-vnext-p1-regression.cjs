...
t('P1 export usa agente P1.1 o sucesor P1.3',/runZuzuVNextUserTurn[\s\S]{0,2600}runZuzuVNextP1(?:1|2|3)Agent/.test(svc));
...
t('UI identifica VNext P1.x',/VNext P1\.[123]|VNext P1/.test(ui)&&/ce_zuzu_vnext_p1_mode/.test(ui));
