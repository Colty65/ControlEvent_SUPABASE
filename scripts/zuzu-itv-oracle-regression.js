...
const cases=[
  ...
  ['KO sujeto físico distinto del esperado',{oracle:{kind:'ledger-structural',action:'query',domain:'purchases',entity:'Vicente',responseKind:'whether'}},{ok:true,title:'Detalle',answer:'Sí. Hay compras bajo responsabilidad de Pocholo.',warnings:[],charts:[],meta:{ledgerAudit:{action:'query',normalizedPlan:{action:'query',response_kind:'whether',query:{domain:'purchases',person:'Vicente'}},execution:{domain:'purchases',answer_payload:{kind:'whether',subject:'Pocholo',person:'Pocholo',value:true}}},resultContext:{ledger:{dataset:{domain:'purchases',row_count:3},view:{displayed_fields:['Responsable','Importe']}}}}},'KO']
];
