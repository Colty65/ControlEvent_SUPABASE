...
assert.match(source,/const VERSION = 'v26_prod_1.2'/);
...
console.log('OK v26_prod_1.2 UI: CSV nativo, recargas cancelables, búsqueda diferida y 5.000 movimientos paginados.');
