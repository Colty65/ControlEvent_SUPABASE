...
assert.match(source,/const VERSION = 'v26_prod_1.1'/);
...
console.log('OK v26_prod_1.1 UI: CSV nativo, recargas cancelables, búsqueda diferida y 5.000 movimientos paginados.');
