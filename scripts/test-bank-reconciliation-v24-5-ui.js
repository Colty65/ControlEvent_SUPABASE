...
assert.match(source,/const VERSION = 'v24_prod-05'/);
...
console.log('OK v24_prod-05 UI: CSV directo, recargas cancelables, búsqueda diferida y 5.000 movimientos paginados.');
