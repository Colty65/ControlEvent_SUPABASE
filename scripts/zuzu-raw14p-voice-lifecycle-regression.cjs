...
t('build RAW14P',/RAW14P-VOICE-COPY-FIX46/.test(voice));
...
t('cache RAW14P',/v22-voz3-zuzu\.js\?v=20260826-RAW14P-VOICE-COPY/.test(index));

console.log(`\nRAW14P VOICE LIFECYCLE · ${pass}/${pass+fail} comprobaciones OK`);process.exit(fail?1:0);
