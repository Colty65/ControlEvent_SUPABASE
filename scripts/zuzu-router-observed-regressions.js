...
run('Hola no hereda persona ni evento',decision('PERSON_OVERVIEW','Colty','SySA 2026','SUMMARY','TRANSACTIONAL'),{message:'Hola',screen_event:{title:'SySA 2026'},logged_user:{nombre:'Colty'},prior_turns:[]},{route:'UNKNOWN',subject:'',event:'',operation:'OTHER'});

run('Perfecto no ejecuta ruta antigua',decision('EVENT_DONATIONS','','SySA 2026','LIST','CONVERSATION'),{message:'Perfecto',screen_event:{title:'SySA 2026'},logged_user:{nombre:'Colty'},prior_turns:[{user:'Dame las donaciones',assistant_tail:'Donaciones de SySA 2026',prior_event:'SySA 2026',result_event:'SySA 2026'}]},{route:'UNKNOWN',subject:'',event:'',operation:'OTHER'});

run('Sus compras tras evento son compras del evento',decision('PERSON_PURCHASES','Colty','SySA 2026','LIST','CONVERSATION'),{message:'Dame sus compras',screen_event:{title:'SySA 2026'},logged_user:{nombre:'Colty'},prior_turns:[{user:'Háblame de SySA 2026',assistant_tail:'Resumen SySA 2026',prior_event:'SySA 2026',result_event:'SySA 2026'}]},{route:'EVENT_PURCHASES',subject:'',event:'SySA 2026',operation:'LIST'});

run('Vuelve a evento corta sujeto personal heredado',decision('PERSON_PURCHASES','Colty','SySA 2026','COMPARE','CONVERSATION'),{message:'Vuelve a SySA 2026',screen_event:{title:'SySA 2026'},logged_user:{nombre:'Colty'},prior_turns:[{user:'Compáralas con las de 2026',assistant_tail:'Comparativa de eventos',prior_event:'SySA 2025',result_event:'SySA 2025'}]},{route:'EVENT_OVERVIEW',subject:'',event:'SySA 2026',operation:'SUMMARY'});
