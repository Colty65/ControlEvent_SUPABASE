...
ok(/controlevent-build" content="20260828-V4_1_EXP-BANK41(?:0-Z1-CLOSURE-SAFEFASTLOCAL-EUR|1-Z1-FINAL-ORACLE-EUR-FAILSAFE)/.test(html),'build general BANK4_10/BANK4_11 actualizado');
