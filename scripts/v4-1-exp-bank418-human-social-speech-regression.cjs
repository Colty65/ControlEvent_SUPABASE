...
(async()=>{
  ...
  check('voz BANK4_18 V51',()=>assert((voice.includes('BANK4_18-Z1H-VOICE-V51')||voice.includes('BANK4_19-Z1H-VOICE-V52'))));
  ...
  check('Ummm completo se conserva',()=>assert((voice.includes('Ummm...................')||voice.includes('Ummmmm...................'))));
  check('cache v48 entretenimiento',()=>assert((voice.includes('entertainment_deck_v48')||voice.includes('entertainment_deck_v49'))));
  const index=fs.readFileSync(path.join(ROOT,'public/index.html'),'utf8');
  check('cache bust BANK418 V51',()=>assert((index.includes('BANK418-Z1H-VOICE-V51')||index.includes('BANK419-Z1H-VOICE-V52'))));
