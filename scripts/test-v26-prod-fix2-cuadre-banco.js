...
assert.match(css,/ControlEvent v27_prod_1.1 FIX4|body\.ce-bank-open > :not\(#ceBankOverlay\)/, 'Debe existir el aislamiento real de la ventana bancaria');
...
console.log('OK v27_prod_1.1 FIX4: controles nativos, En saldo exacto, fichas PC/móvil y globo canónico.');
