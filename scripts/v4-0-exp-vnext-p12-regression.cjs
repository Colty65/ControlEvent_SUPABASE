...
t('export usa agente P1.2 o sucesor P1.3',/runZuzuVNextUserTurn[\s\S]{0,2200}runZuzuVNextP1(?:2|3)Agent/.test(svc));
...
t('UI identifica P1.2 o sucesor P1.3',/VNext P1\.[23]/.test(ui)&&/(paralelo|una sola IA)/i.test(ui));
t('cache bust P1.2 o sucesor P1.3',/VNEXT-P1(?:2-SCREEN-PARALLEL|3-CONTEXT-ALIAS-WEATHER)/.test(index));
...
t('soft failure P1.2+ conserva conversación',/provider:'zuzu-vnext-p1(?:2|3)-soft-failure'/.test(svc));
