...
t('export usa agente P1.2 o sucesor P1.4',/runZuzuVNextUserTurn[\s\S]{0,2200}runZuzuVNextP1(?:2|3)Agent/.test(svc));
...
t('UI identifica P1.2 o sucesor P1.4',/VNext P1\.[234]/.test(ui)&&/(paralelo|una sola IA)/i.test(ui));
t('cache bust P1.2 o sucesor P1.4',/VNEXT-P1(?:2-SCREEN-PARALLEL|3-CONTEXT-ALIAS-WEATHER|4-PENA-FRIEND-COMPARE-CHARTS)/.test(index));
...
t('soft failure P1.2+ conserva conversación',/provider:'zuzu-vnext-p1(?:2|3|4)-soft-failure'/.test(svc));
