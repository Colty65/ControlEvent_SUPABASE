...
t('microseñales son pensamiento breve',voice.includes("Ummmmm...................")&&voice.includes("Calla............... ya lo tengo....., besitos muá.")&&voice.includes('punta de la lengua'));
...
t('cache bust Z1 humanidad aplicado',index.includes('BANK415-Z1H-VOICE-V47')||index.includes('BANK417-Z1H-VOICE-V49')||(index.includes('BANK418-Z1H-VOICE-V51')||index.includes('BANK419-Z1H-VOICE-V52')||index.includes('BANK420-Z1H-VOICE-V53')));
