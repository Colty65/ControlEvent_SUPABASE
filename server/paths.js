...
export const APP_VERSION = 'ControlEvent v26_prod_1.1';

export const APP_VERSION_LABEL = 'v26_prod_1.1';
export const APP_VERSION_FILE = 'ControlEvent_v26_prod_1.1';
export const BUILD_ID = '20260809-V26-PROD-1-1-GEMINI-INTERACTIONS-AFINADO';
export const ZIP_NAME = 'CE_V26_PROD_1_1_ZUZU_GEMINI_INTERACTIONS_AFINADO.zip';
