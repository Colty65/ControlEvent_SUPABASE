-- ControlEvent v4_1_exp · VNext P1.21
...
-- Fuente de verdad: services/zuzu-capability-registry.service.js · 20260901-P121.
...
insert into public.ce_zuzu_capabilities(operation,module,registry_version,required_keys,optional_keys,guarded_keys,defaults,result_contract,enabled,updated_at) values
  ('people_catalog','PERSONAS','20260901-P121','[]'::jsonb,'["population","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'people_catalog',true,now()),
  ('events_catalog','EVENTOS','20260901-P121','[]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'events_catalog',true,now()),
  ('person_profile','PERSONAS','20260901-P121','["person"]'::jsonb,'["event","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'person_dossier',true,now()),
  ('person_events','PERSONAS','20260901-P121','["person"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'person_events',true,now()),
  ('person_income_status','INGRESOS','20260901-P121','["person","event"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'person_income_status',true,now()),
  ('person_event_status','PERSONAS','20260901-P121','["person","event"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'person_event_status',true,now()),
  ('event_income_status','INGRESOS','20260901-P121','["event"]'::jsonb,'["status","population","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{"status":"pending","population":"all"}'::jsonb,'income_status',true,now()),
  ('event_income_lines','INGRESOS','20260901-P121','["event"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'income_lines',true,now()),
  ('event_attendance','ASISTENCIA','20260901-P121','["event"]'::jsonb,'["attendance_mode","scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{"attendance_mode":"attendees"}'::jsonb,'attendance',true,now()),
  ('event_summary','EVENTO','20260901-P121','["event"]'::jsonb,'["scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'event_dossier',true,now()),
  ('event_scenario','ESCENARIOS','20260901-P121','["event"]'::jsonb,'["income_delta","scenario_people","plan","plan_detail","plan_focus","plan_target","chart","chart_type","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'scenario',true,now()),
  ('event_purchases','COMPRAS','20260901-P121','["event"]'::jsonb,'["purchase_status","status","responsible","mine","order_by","store_filter_mode","include_stores","exclude_stores","exclude_products","visible_columns","hidden_columns","view_filters","view_sort","reset_table","top_n","derive_operation","derive_field","field","label_field","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count"]'::jsonb,'[]'::jsonb,'{"purchase_status":"realized","store_filter_mode":"all"}'::jsonb,'purchase_dataset',true,now()),
  ('event_donations','DONACIONES','20260901-P121','["event"]'::jsonb,'["scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'donation_dataset',true,now()),
  ('event_bank','BANCO','20260901-P121','["event"]'::jsonb,'["scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'bank_summary',true,now()),
  ('event_weather','TIEMPO','20260901-P121','["event"]'::jsonb,'["start_date","end_date","chart","chart_type","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'weather',true,now()),
  ('event_stores_used','TIENDAS','20260901-P121','["event"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'event_stores',true,now()),
  ('event_products','PRODUCTOS','20260901-P121','["event"]'::jsonb,'["detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'event_products',true,now()),
  ('compare_events','COMPARACION','20260901-P121','["events"]'::jsonb,'["metric","chart","chart_type","derive_operation","derive_field","field","label_field","top_n","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{"metric":"all"}'::jsonb,'comparison',true,now()),
  ('event_documentation','DOCUMENTOS','20260901-P121','["event"]'::jsonb,'["scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'event_documentation',true,now()),
  ('event_management','GESTION','20260901-P121','["event"]'::jsonb,'["scope","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'event_management',true,now()),
  ('store_purchases','TIENDAS','20260901-P121','["store"]'::jsonb,'["event","scope","status","include_empty","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{"scope":"all_events","status":"realized"}'::jsonb,'store_purchases',true,now()),
  ('events_overview','EVENTOS','20260901-P121','[]'::jsonb,'["scope","metric","chart","chart_type","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_operation","source_args","source_dataset_id","dataset_id","table_key","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{"metric":"all"}'::jsonb,'events_overview',true,now()),
  ('derive','DERIVACION','20260901-P121','["derive_operation"]'::jsonb,'["field","derive_field","label_field","table_key","top_n","source_operation","source_args","detail","tone","register","tease","narrate","requested_fields","focus_mode","focus_type","focus_entities","source_dataset_id","dataset_id","title","record_count","view_filters","view_sort","visible_columns","hidden_columns","reset_table","order_by"]'::jsonb,'[]'::jsonb,'{}'::jsonb,'derived_dataset',true,now())
