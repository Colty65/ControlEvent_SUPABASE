...
(function(){
  ...
  const VERSION = 'v28.5_prod_FIX14_login_unblock';
  ...
  function storeUser(u0){
    ...
    try{ sessionStorage.setItem('ControlEvent_v28.5_prod_login_user', JSON.stringify(u)); sessionStorage.setItem('ControlEvent_ce_acceso_usuario', JSON.stringify(u.ce_acceso)); }catch(_){ }
    try{ localStorage.setItem('ControlEvent_v28.5_prod_login_user', JSON.stringify(u)); localStorage.setItem('ControlEvent_ce_acceso_usuario', JSON.stringify(u.ce_acceso)); }catch(_){ }
