/* ControlEvent v27_prod_1.2 - saneamiento de versión visible y diagnóstico. */
(function(){
  'use strict';
  if(window.__ceV18114VersionTrace) return;
  window.__ceV18114VersionTrace = true;
  var VERSION_LABEL = 'v27_prod_1.2';
  var VERSION_TEXT = 'ControlEvent v27_prod_1.2';
  var VERSION_FILE = 'ControlEvent_v27_prod_1.2';
  var BUILD_ID = '20260810-V27-PROD-1-2-ZUZU-FIABILIDAD-SEMANTICA';
  var ZIP_NAME = 'CE_V27_PROD_1_2_ZUZU_FIABILIDAD_SEMANTICA.zip';
  ...
  function setGlobals(){
    try{
      ...
      window.ControlEventVersion = {label:VERSION_LABEL, version:VERSION_TEXT, versionFile:VERSION_FILE, build:BUILD_ID, zip:ZIP_NAME, source:'v18-11-9-version-trace.js'};
      if(document.body){
