/* ControlEvent v27_prod_1.0 FIX26
...
(function(){
  'use strict';
  if(window.__ceV17Fix26MobileResumenWelcomeInfo) return;
  window.__ceV17Fix26MobileResumenWelcomeInfo = true;

  const STYLE_ID = 'ceV17Fix26WelcomeInfoStyle';
  const LAYER_ID = 'ceV17Fix26WelcomeInfoLayer';
  const VERSION_LABEL = 'v27_prod_1.0_FIX26';
  ...
  window.ControlEventV17Fix26MobileResumenWelcomeInfo = {version:VERSION_LABEL, showInfo, closeInfo, isPhoneOnly, welcomeActive};
})();
