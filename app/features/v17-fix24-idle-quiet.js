/* ControlEvent v27_prod_1.0 FIX24 - modo reposo: reduce ventilador/longtasks en PC y móviles.
...
(function(){
  ...
  function status(){
    ...
    return {
      version:'v27_prod_1.0_fix24_idle_quiet',
  ...
  window.ControlEventFix24IdleQuiet = {version:'v27_prod_1.0_fix24_idle_quiet', status, quiet:function(){ clearPerfLiveNoise(); closeStaleTransientUi(); return status(); }};
