/* ControlEvent v27_prod_1.2 - versión centralizada */
export const VERSION = 'v27_prod_1.2';
export const VERSION_LABEL = 'v27_prod_1.2';
export const VERSION_TEXT = 'ControlEvent v27_prod_1.2';
export const VERSION_FILE = 'ControlEvent_v27_prod_1.2';
...
try {
  // v27_prod_1.2: migración única de claves internas heredadas sin perder sesión/preferencias.
  for (const store of [window.localStorage, window.sessionStorage]) {
    try {
      ...
      for (let i = 0; i < store.length; i += 1) {
        ...
        const newKey = oldKey.replace(/^ControlEvent_v24_prod/, 'ControlEvent_v27_prod_1.2');
