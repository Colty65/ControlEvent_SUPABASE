/* ControlEvent v26_prod_1.0 - versión centralizada */
export const VERSION = 'v26_prod_1.0';
export const VERSION_LABEL = 'v26_prod_1.0';
export const VERSION_TEXT = 'ControlEvent v26_prod_1.0';
...
try {
  // v26_prod_1.0: migración única de claves internas heredadas sin perder sesión/preferencias.
  for (const store of [window.localStorage, window.sessionStorage]) {
    try {
      ...
      for (let i = 0; i < store.length; i += 1) {
        ...
        const newKey = oldKey.replace(/^ControlEvent_v24_prod/, 'ControlEvent_v26_prod_1.0');
