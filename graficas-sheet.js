/* ControlEvent v30.9 - LowResourceLegacyPatch
...
(function(){
  ...
  function liteRender(){
    ...
    try{
      ...
      // Punto clave v30.9: primer render autenticado y cambio real de evento no se recortan.
  ...
  function print(){
    ...
    console.group('[ControlEventLowResourceLegacy/ControlEvent v30.9]');
    console.info(report);
  ...
  try{ console.info('[ControlEventLowResourceLegacy/ControlEvent v30.9] Render legacy recortado + Mapa de productos activado.'); }catch(_){ }
})();
