# ControlEvent v17_prod FIX26 - móvil resumen + bienvenida ColtyLAB
...
2. **Solo móviles tipo teléfono** en pantalla de bienvenida sin evento seleccionado:
   ...
   - Se muestra una ficha informativa de `Control_Event_App` con el texto solicitado y pie `(c)oltyLAB '26 - v17_prod_FIX26`.
