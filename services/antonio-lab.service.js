...
export function antonioLabConfig(){return {ok:true,build:BUILD,configured:Boolean(geminiKey()),provider:'Gemini STT + VNext/CE + Gemini 3.1 Flash TTS streaming (Interactions API)',sttModel:model(),ttsModel:'gemini-3.1-flash-tts-preview',voiceId:'Algenib',voiceProfile:'hombre de unos 64 años, grave, áspero, campechano y natural',fallbackVoiceId:'es_ES-davefx-medium',wakeMode:'Activar = despierto; Dormir = wake semántico',paidNewServices:0,ttsTransport:'Interactions API v1beta · stream=true',notes:'Base estable V3.12. Algenib sigue como voz principal; DaveFX sólo es respaldo. Ajustes limitados a latencia, fecha, personalidad y STT fantasma.'}}
