# CE v17_prod FIX35 - Planificación: Gemini ultracorto

Base: CE_v17_PROD_FIX34_PLANIFICACION_PARSER_DONACIONES_MOMENTOS_TIMEOUT.

Objetivo: no añadir otra capa de imaginación local, sino reducir el encargo que recibe Gemini para que responda rápido y útil.

Cambios:

1. Prompt ultracorto para Encargo total a Zuzu.
   - Gemini ya no recibe el JSON enorme con catálogo completo, precios, trazas y textos duplicados.
...
4. Trazabilidad mantenida.
   - La app sigue mostrando la caja negra: días, momentos, donaciones, tamaño real del prompt y respuesta de Gemini.
