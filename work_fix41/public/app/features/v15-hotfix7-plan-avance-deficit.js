(function(){
  ...
  function injectStyle(){
    ...
    st.textContent=`#summaryTiendaTicket .summary-item.ce-v15hf7-summary-collapsed{cursor:pointer;min-height:44px;align-items:center}#summaryTiendaTicket .summary-item.ce-v15hf7-summary-collapsed>span:first-child{display:block;max-width:calc(100% - 120px);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#summaryTiendaTicket .summary-item.ce-v15hf7-summary-collapsed>span:first-child:after{content:'  ⓘ';font-weight:900;color:#2563eb}#summaryTiendaTicket .summary-item.ce-v15hf7-summary-pending>span:first-child{font-weight:950;color:#dc2626}#budgetLayout .budget-panel.donantes .ce-v15hf7-avance-box{margin-top:14px;padding:12px;border:2px solid #0f172a;border-radius:18px;background:linear-gradient(180deg,#fffef9 0%,#ffffff 100%);box-shadow:0 12px 24px rgba(15,23,42,.10)}#budgetLayout .budget-panel.donantes .ce-v15hf7-title{font-size:16px;font-weight:950;margin-bottom:8px;letter-spacing:.02em;color:#0f172a}.ce-v15hf7-progress-row{padding:8px 9px;border:1px solid rgba(148,163,184,.28);border-radius:14px;background:#f8fafc;display:flex;flex-direction:column;gap:5px;margin:0 0 8px 0}.ce-v15hf7-progress-head{display:flex;justify-content:space-between;gap:10px;align-items:center}.ce-v15hf7-progress-head b{font-size:11px;line-height:1.15;text-transform:uppercase;color:#0f172a}.ce-v15hf7-progress-head strong{font-size:15px;line-height:1;color:#0f172a}.ce-v15hf7-track{height:9px;background:#e5e7eb;border-radius:999px;overflow:hidden}.ce-v15hf7-track i{display:block;height:100%;border-radius:999px}.ce-v15hf7-progress-copy{display:grid;gap:4px}.ce-v15hf7-progress-row small{font-size:12px;line-height:1.25;font-weight:700;color:#334155}.ce-v15hf7-progress-row em{font-style:normal;font-size:11px;line-height:1.25;color:#9a3412;background:#fff7ed;border:1px solid #fdba74;border-radius:10px;padding:5px 7px;font-weight:800}`;
