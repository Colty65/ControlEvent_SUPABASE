...
Cambios:
- BACKUP: corregida la versión de METADATOS para que informe ControlEvent v16_prod y ControlEvent_v16_prod.
...
No se toca login, datos, globos generales ni rendimiento.
