-- ============================================================================
-- ControlEvent v27_prod_1.0 FIX8 · CUADRE BANCO, TRAZABILIDAD DE COMPRAS E INGRESOS
...
-- Actualización segura para instalaciones que ya tenían la versión v27_prod_1.0-02.
...
comment on column public.ce_bank_movements.included is 'Valor inicial heredado. Desde v27_prod_1.0-04 la inclusión efectiva se guarda por evento en ce_bank_event_movement_state.';
