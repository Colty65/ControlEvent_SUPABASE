...
- Gemini no consulta tablas, no ejecuta SQL y no puede modificar datos.
...
Si la petición es demasiado amplia, ambigua o requiere demasiados datos, ControlEvent responde sin llamar a Gemini:
