# ControlEvent v27.0.2 - Corrección Excel/Backup

Correcciones sobre v27.0:

1. INFOEVENTO y textos emitidos pasan a usar `ControlEvent_v27_0_2` en el nombre de fichero y `ControlEvent v27.0.2` en metadatos.
