# ControlEvent v18.11.5_prod · Zuzu con tokens optimizados
...
- Versionado único actualizado a `v18.11.5_prod` y cache-busting nuevo.
...
- `node --check public/app/features/v18-11-5-version-trace.js`
