# ControlEvent v18.11.4_prod · Zuzu con tokens optimizados
...
- Versionado único actualizado a `v18.11.4_prod` y cache-busting nuevo.
...
- `node --check public/app/features/v18-11-4-version-trace.js`
